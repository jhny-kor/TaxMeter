const ONTOLOGY_DATA = {
  ...
  "split_exports": {
    "local_government_supports": {
      "path": "ontology/exports/korea-local-government-supports-ontology-2026.json",
      "item_count": 7820,
  ...
  "items": [
      ...
      "criteria": [
        {
          ...
          "condition": "만 9세 미만",
          "age_max": 8,
          "source": "source.mohw.child-allowance.2026",
          "criteria_kind": "eligibility",
          "basis_category": "age",
          "basis_definition": "신청일, 계좌개설일 또는 과세기간 기준으로 대상자의 만 나이를 계산한 선정 기준입니다.",
          "basis_lookup": "주민등록상 생년월일과 해당 제도의 기준일로 확인합니다.",
          "selection_rule": "age_min과 age_max가 있으면 해당 나이 범위에 포함되는지 판정하고 병역기간 차감 등 특례가 있으면 note를 함께 적용합니다.",
          "basis_source": "source.mohw.child-allowance.2026",
          "amount_applicability": "정액 금액 기준 없음"
        },
        {
          "label": "기본 월 지급액",
        ...
        },
        {
          "label": "지역 우대 월 지급액",
          "basis": "아동 1인당 월 지급액",
          "condition": "비수도권·인구감소지역 등",
          "amount_krw": 130000,
          "note": "공식 안내상 월 10만~13만원 범위",
          "source": "source.mohw.child-allowance.2026",
          "criteria_kind": "reference",
          "basis_category": "official-standard",
          "basis_definition": "해당 제도에서 대상 여부, 세율, 공제액, 한도 또는 신고기한을 판정하기 위해 공식 출처가 사용하는 기준항목입니다.",
      ...
      "criteria": [
        {
          ...
          "condition": "첫째 출생아",
          "amount_krw": 2000000,
          "source": "source.mohw.first-meeting-voucher",
          "criteria_kind": "reference",
          "basis_category": "official-standard",
          "basis_definition": "해당 제도에서 대상 여부, 세율, 공제액, 한도 또는 신고기한을 판정하기 위해 공식 출처가 사용하는 기준항목입니다.",
          "basis_lookup": "각 criterion의 출처 노드와 관련 신고·신청 서류에서 확인합니다.",
          "selection_rule": "조건 문구와 구조화된 금액·비율·기간 필드를 함께 보고 해당 구간 또는 요건을 선택합니다.",
          "basis_source": "source.mohw.first-meeting-voucher"
        },
        {
          "label": "둘째 이상",
          "basis": "출생순위",
        ...
        },
        {
          "label": "신청 가능 출생아",
          "basis": "출생신고와 주민등록번호",
          "condition": "출생신고되어 정상적으로 주민등록번호를 부여받은 아동",
          "amount_applicability": "정액 금액 기준 없음",
          "source": "source.mohw.first-meeting-voucher",
          "criteria_kind": "reference",
          "basis_category": "official-standard",
      ...
      "criteria": [
        {
          "label": "1인 가구 선정기준",
          "basis": "소득인정액",
          "condition": "기준 중위소득 48% 이하",
          "household_size": 1,
          "median_income_percent_max": 48,
          "threshold_krw_max": 1230834,
          "source": "source.myhome.housing-benefit.2026",
          "criteria_kind": "eligibility",
          "basis_category": "median-income",
          "basis_definition": "복지·정책금융 지원대상 선정을 위해 가구원 수별 기준 중위소득에 일정 비율을 곱해 산정하는 소득 기준입니다.",
          "basis_lookup": "정부24·금융위원회·지원기관의 해당 연도 가구원 수별 기준 중위소득 표에서 확인합니다.",
        ...
        },
        {
          ...
          "basis_lookup": "각 criterion의 출처 노드와 관련 신고·신청 서류에서 확인합니다.",
          "selection_rule": "조건 문구와 구조화된 금액·비율·기간 필드를 함께 보고 해당 구간 또는 요건을 선택합니다.",
          "basis_source": "source.myhome.housing-benefit.2026"
        },
        {
          "label": "자가가구 경보수",
          "basis": "수선유지급여",
      ...
      "criteria": [
        {
          ...
          "amount_krw": 1000000,
          "note": "월 지급액",
          "source": "source.mohw.parent-benefit.2026",
          "criteria_kind": "eligibility",
          "basis_category": "official-standard",
          "basis_definition": "해당 제도에서 대상 여부, 세율, 공제액, 한도 또는 신고기한을 판정하기 위해 공식 출처가 사용하는 기준항목입니다.",
          "basis_lookup": "각 criterion의 출처 노드와 관련 신고·신청 서류에서 확인합니다.",
          "selection_rule": "조건 문구와 구조화된 금액·비율·기간 필드를 함께 보고 해당 구간 또는 요건을 선택합니다.",
          "basis_source": "source.mohw.parent-benefit.2026"
        },
        {
          "label": "1세 아동",
          "basis": "아동 월령",
        ...
        },
        {
          "label": "지원대상",
          "basis": "아동 나이",
          "condition": "2세 미만 0~23개월",
          "period_months_max": 23,
          "source": "source.mohw.parent-benefit.2026",
          "criteria_kind": "period",
          "basis_category": "age",
          "basis_definition": "신청일, 계좌개설일 또는 과세기간 기준으로 대상자의 만 나이를 계산한 선정 기준입니다.",
      ...
      "criteria": [
        {
          "label": "신청대상",
          "basis": "사업장 상태",
          "condition": "신청일 현재 정상적으로 영업 중인 소상공인",
          "amount_applicability": "정액 금액 기준 없음",
          "source": "source.bizinfo.small-business-leap.2026",
          "criteria_kind": "reference",
          "basis_category": "official-standard",
          "basis_definition": "해당 제도에서 대상 여부, 세율, 공제액, 한도 또는 신고기한을 판정하기 위해 공식 출처가 사용하는 기준항목입니다.",
          "basis_lookup": "각 criterion의 출처 노드와 관련 신고·신청 서류에서 확인합니다.",
          "selection_rule": "조건 문구와 구조화된 금액·비율·기간 필드를 함께 보고 해당 구간 또는 요건을 선택합니다.",
          "basis_source": "source.bizinfo.small-business-leap.2026"
        },
        {
          "label": "신청기간",
          "basis": "공고 신청기간",
          "condition": "2026년 4월 1일~4월 24일",
          "deadline_start_month": 4,
          "deadline_start_day": 1,
          "deadline_end_month": 4,
          "deadline_end_day": 24,
          "source": "source.bizinfo.small-business-leap.2026",
          "criteria_kind": "deadline",
          "basis_category": "official-standard",
      ...
      "criteria": [
        {
          ...
          "condition": "0원 초과",
          "threshold_krw_min": 1,
          "source": "source.bizinfo.small-business-management-voucher.2026",
          "criteria_kind": "threshold",
          "basis_category": "revenue",
          "basis_definition": "사업자의 과세유형, 지원대상, 납부의무 면제 또는 대출대상 판단에 쓰는 매출·공급대가 기준입니다.",
          "basis_lookup": "부가가치세 신고서, 사업장 매출자료, 세금계산서·현금영수증·카드매출 자료에서 확인합니다.",
        ...
        },
        {
          ...
          "basis_lookup": "각 criterion의 출처 노드와 관련 신고·신청 서류에서 확인합니다.",
          "selection_rule": "조건 문구와 구조화된 금액·비율·기간 필드를 함께 보고 해당 구간 또는 요건을 선택합니다.",
          "basis_source": "source.bizinfo.small-business-management-voucher.2026"
        }
      ],
      "tags": [
        "voucher",
      ...
      "criteria": [
        {
          "label": "공통 대상",
          "basis": "지원대상",
          "condition": "소상공인기본법상 소상공인",
          "amount_applicability": "정액 금액 기준 없음",
          "source": "source.bizinfo.small-business-policy-fund.2026",
          "criteria_kind": "reference",
          "basis_category": "person-status",
          "basis_definition": "세법 또는 지원제도에서 대상자로 인정하는 사람의 관계, 고용상태, 가족상태, 사회적 지위 기준입니다.",
          "basis_lookup": "가족관계증명, 주민등록, 재직·퇴직 자료, 지원기관 자격확인 서류에서 확인합니다.",
          "selection_rule": "대상자 지위가 condition에 맞는지 확인하고 소득·나이·기간 등 부가 요건을 함께 충족해야 합니다.",
          "basis_source": "source.bizinfo.small-business-policy-fund.2026"
        },
        {
          "label": "운전자금 통합한도",
          "basis": "정책자금 대출잔액과 신규대출 예정액",
          "condition": "기업당 운전자금 5억원 이내",
          "limit_krw": 500000000,
          "source": "source.bizinfo.small-business-policy-fund.2026",
          "criteria_kind": "limit",
          "basis_category": "official-standard",
        ...
        },
        {
          "label": "시설자금 포함 통합한도",
          "basis": "정책자금 대출잔액과 신규대출 예정액",
          "condition": "시설자금 포함 10억원 이내",
          "limit_krw": 1000000000,
          "source": "source.bizinfo.small-business-policy-fund.2026",
          "criteria_kind": "limit",
          "basis_category": "official-standard",
          "basis_definition": "해당 제도에서 대상 여부, 세율, 공제액, 한도 또는 신고기한을 판정하기 위해 공식 출처가 사용하는 기준항목입니다.",
        ...
        },
        {
          "label": "대환대출 대상 고금리",
          "basis": "기존 금융권 대출금리",
          "condition": "7% 이상 고금리 대출",
          "rate_percent_min": 7,
          "rate_label": "기존대출 금리",
          "source": "source.bizinfo.small-business-policy-fund.2026",
          "criteria_kind": "rate",
          "rate_basis": "기존 금융권 대출금리",
          "basis_category": "finance-rate",
          "basis_definition": "정책금융 상품에서 이자율, 보증료율, 담보·소득 대비 대출 가능 비율을 정하는 금융 기준입니다.",
          "basis_lookup": "지원기관의 월별 금리표, 상품설명서, 보증심사 결과에서 확인합니다.",
          "selection_rule": "rate_percent 또는 rate_percent_min/max를 적용하되 금리·보증료율·LTV·DTI는 세액계산이 아니라 금융한도 판정용 비율로 해석합니다.",
          "basis_source": "source.bizinfo.small-business-policy-fund.2026",
          "amount_formula": "기존 금융권 대출금리 × 기존대출 금리 7% 이상"
        },
        {
          "label": "대환대출 금리",
          "basis": "전환 후 정책자금 금리",
          ...
          "source": "source.bizinfo.small-business-policy-fund.2026",
          "criteria_kind": "rate",
          "rate_basis": "전환 후 정책자금 금리",
          "basis_category": "finance-rate",
          "basis_definition": "정책금융 상품에서 이자율, 보증료율, 담보·소득 대비 대출 가능 비율을 정하는 금융 기준입니다.",
          "basis_lookup": "지원기관의 월별 금리표, 상품설명서, 보증심사 결과에서 확인합니다.",
          "selection_rule": "rate_percent 또는 rate_percent_min/max를 적용하되 금리·보증료율·LTV·DTI는 세액계산이 아니라 금융한도 판정용 비율로 해석합니다.",
          "basis_source": "source.bizinfo.small-business-policy-fund.2026",
          "amount_formula": "전환 후 정책자금 금리 × 대출금리 4.5%"
        },
        {
          "label": "성실상환 우대금리",
          "basis": "소진공 직접대출 성실상환",
          "condition": "최근 3년 이내 연속 10일 이상 연체 이력 없이 상환",
          "rate_percent": 0.3,
          "rate_label": "금리우대",
          "source": "source.bizinfo.small-business-policy-fund.2026",
          "period_years_max": 3,
          "criteria_kind": "rate",
          "rate_basis": "소진공 직접대출 성실상환",
          "basis_category": "finance-rate",
          "basis_definition": "정책금융 상품에서 이자율, 보증료율, 담보·소득 대비 대출 가능 비율을 정하는 금융 기준입니다.",
          "basis_lookup": "지원기관의 월별 금리표, 상품설명서, 보증심사 결과에서 확인합니다.",
          "selection_rule": "rate_percent 또는 rate_percent_min/max를 적용하되 금리·보증료율·LTV·DTI는 세액계산이 아니라 금융한도 판정용 비율로 해석합니다.",
          "basis_source": "source.bizinfo.small-business-policy-fund.2026",
          "amount_formula": "소진공 직접대출 성실상환 × 금리우대 0.3%"
        }
      ],
      "tags": [
        "policy-finance",
    ...
    },
    {
      ...
      "criteria": [
        {
          "label": "고용유지 요건",
          "basis": "정규직 청년 채용 후 고용유지",
          "condition": "6개월 이상 고용 유지",
          "period_months_min": 6,
          "source": "source.korea.youth-job-leap.2026",
          "criteria_kind": "period",
          "basis_category": "official-standard",
          "basis_definition": "해당 제도에서 대상 여부, 세율, 공제액, 한도 또는 신고기한을 판정하기 위해 공식 출처가 사용하는 기준항목입니다.",
          "basis_lookup": "각 criterion의 출처 노드와 관련 신고·신청 서류에서 확인합니다.",
          "selection_rule": "조건 문구와 구조화된 금액·비율·기간 필드를 함께 보고 해당 구간 또는 요건을 선택합니다.",
          "basis_source": "source.korea.youth-job-leap.2026",
          "amount_applicability": "정액 금액 기준 없음"
        },
        {
          "label": "지원금액",
          "basis": "기업과 청년 지원금",
          "condition": "최대 720만원/년",
          "limit_krw": 7200000,
          "source": "source.korea.youth-job-leap.2026",
          "criteria_kind": "limit",
          "basis_category": "official-standard",
    ...
    },
    {
      ...
      "criteria": [
        ...
        },
        {
          "label": "월환산임차료",
          "basis": "보증금과 월임차료",
          "condition": "월임차료 70만원 초과 시 환산",
          "threshold_krw_min": 700000,
          "amount_formula": "(보증금 × 5.5%) ÷ 12 + 월임차료",
          "source": "source.myhome.youth-monthly-rent.2026",
          "criteria_kind": "formula",
          "basis_category": "official-standard",
          "basis_definition": "해당 제도에서 대상 여부, 세율, 공제액, 한도 또는 신고기한을 판정하기 위해 공식 출처가 사용하는 기준항목입니다.",
