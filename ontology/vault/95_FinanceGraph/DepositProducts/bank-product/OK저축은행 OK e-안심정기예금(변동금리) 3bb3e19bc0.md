---
materialized_id: "finance.bank.deposit.0013351.240071"
title: "OK저축은행 OK e-안심정기예금(변동금리)"
type: "bank-product"
...
# OK저축은행 OK e-안심정기예금(변동금리)

OK저축은행의 정기예금 상품 'OK e-안심정기예금(변동금리)' 공시 정보입니다.

> Graph-only materialization입니다. 원본 데이터는 JSON export가 authoritative source입니다.

## Metadata
- Materialized ID: `finance.bank.deposit.0013351.240071`
- Type: `bank-product`
- provider: OK저축은행
...
- related: `category.finance.source-health`, `finance.provider.738410451753`, `category.finance.financial-provider-registry`, `category.finance.benchmark-rates`, `finance.benchmark-rate.bok-base-rate`
