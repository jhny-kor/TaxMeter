---
materialized_id: "finance.bank.deposit.0014807.10120114700011"
title: "수협은행 헤이(Hey)정기예금"
type: "bank-product"
...
수협은행의 정기예금 상품 '헤이(Hey)정기예금' 공시 정보입니다.

> Graph-only materialization입니다. 원본 데이터는 JSON export가 authoritative source입니다.

## Metadata
- Materialized ID: `finance.bank.deposit.0014807.10120114700011`
- Type: `bank-product`
- provider: 수협은행
...
- related: `category.finance.source-health`, `finance.provider.7a92a1d5a061`, `category.finance.financial-provider-registry`, `category.finance.benchmark-rates`, `finance.benchmark-rate.bok-base-rate`
