---
materialized_id: "finance.bank.deposit.0010464.240016"
title: "영진저축은행 SB톡톡-정기예금"
type: "bank-product"
...
영진저축은행의 정기예금 상품 'SB톡톡-정기예금' 공시 정보입니다.

> Graph-only materialization입니다. 원본 데이터는 JSON export가 authoritative source입니다.

## Metadata
- Materialized ID: `finance.bank.deposit.0010464.240016`
- Type: `bank-product`
- provider: 영진저축은행
