---
materialized_id: "finance.deposit.deposit.0010488.240050"
title: "우리금융저축은행 e-회전정기예금"
type: "bank-product"
...
우리금융저축은행의 정기예금 상품 'e-회전정기예금' 공시 정보입니다.

> Graph-only materialization입니다. 원본 데이터는 JSON export가 authoritative source입니다.

## Metadata
- Materialized ID: `finance.deposit.deposit.0010488.240050`
- Type: `bank-product`
- provider: 우리금융저축은행
...
- related: `category.finance.source-health`, `finance.provider.885236827ece`, `category.finance.financial-provider-registry`, `category.finance.benchmark-rates`, `finance.benchmark-rate.bok-base-rate`
