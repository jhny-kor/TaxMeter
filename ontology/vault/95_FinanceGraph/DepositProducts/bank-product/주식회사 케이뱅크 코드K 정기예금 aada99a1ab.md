---
materialized_id: "finance.bank.deposit.0014674.01013000110000000001"
title: "주식회사 케이뱅크 코드K 정기예금"
type: "bank-product"
...
주식회사 케이뱅크의 정기예금 상품 '코드K 정기예금' 공시 정보입니다.

> Graph-only materialization입니다. 원본 데이터는 JSON export가 authoritative source입니다.

## Metadata
- Materialized ID: `finance.bank.deposit.0014674.01013000110000000001`
- Type: `bank-product`
- provider: 주식회사 케이뱅크
...
- related: `category.finance.source-health`, `finance.provider.d4999685fe34`, `category.finance.financial-provider-registry`, `category.finance.benchmark-rates`, `finance.benchmark-rate.bok-base-rate`
