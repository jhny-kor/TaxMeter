---
materialized_id: "finance.bank.deposit.0010354.mk240002"
title: "민국저축은행 e-행복정기예금 (인터넷)"
type: "bank-product"
...
민국저축은행의 정기예금 상품 'e-행복정기예금 (인터넷)' 공시 정보입니다.

> Graph-only materialization입니다. 원본 데이터는 JSON export가 authoritative source입니다.

## Metadata
- Materialized ID: `finance.bank.deposit.0010354.mk240002`
- Type: `bank-product`
- provider: 민국저축은행
...
- related: `category.finance.source-health`, `finance.provider.c9c30847d336`, `category.finance.financial-provider-registry`, `category.finance.benchmark-rates`, `finance.benchmark-rate.bok-base-rate`
