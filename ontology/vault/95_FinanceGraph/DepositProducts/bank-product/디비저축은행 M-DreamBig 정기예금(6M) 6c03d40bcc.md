---
materialized_id: "finance.bank.deposit.0010349.240862"
title: "디비저축은행 M-DreamBig 정기예금(6M)"
type: "bank-product"
...
# 디비저축은행 M-DreamBig 정기예금(6M)

디비저축은행의 정기예금 상품 'M-DreamBig 정기예금(6M)' 공시 정보입니다.

> Graph-only materialization입니다. 원본 데이터는 JSON export가 authoritative source입니다.

## Metadata
- Materialized ID: `finance.bank.deposit.0010349.240862`
- Type: `bank-product`
- provider: 디비저축은행
...
- related: `category.finance.source-health`, `finance.provider.90ec31cf04aa`, `category.finance.financial-provider-registry`, `category.finance.benchmark-rates`, `finance.benchmark-rate.bok-base-rate`
