---
materialized_id: "finance.bank.deposit.0010366.024241001"
title: "조은저축은행 정기예금(여수지점)"
type: "bank-product"
...
조은저축은행의 정기예금 상품 '정기예금(여수지점)' 공시 정보입니다.

> Graph-only materialization입니다. 원본 데이터는 JSON export가 authoritative source입니다.

## Metadata
- Materialized ID: `finance.bank.deposit.0010366.024241001`
- Type: `bank-product`
- provider: 조은저축은행
