---
materialized_id: "finance.deposit.deposit.0011767.240046"
title: "JT저축은행 회전식정기예금(변동금리상품)"
type: "bank-product"
...
# JT저축은행 회전식정기예금(변동금리상품)

JT저축은행의 정기예금 상품 '회전식정기예금(변동금리상품)' 공시 정보입니다.

> Graph-only materialization입니다. 원본 데이터는 JSON export가 authoritative source입니다.

## Metadata
- Materialized ID: `finance.deposit.deposit.0011767.240046`
- Type: `bank-product`
- provider: JT저축은행
