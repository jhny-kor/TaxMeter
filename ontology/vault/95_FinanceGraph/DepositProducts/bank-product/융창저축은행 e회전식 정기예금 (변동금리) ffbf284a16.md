---
materialized_id: "finance.deposit.deposit.0010467.243000"
title: "융창저축은행 e회전식 정기예금 (변동금리)"
type: "bank-product"
...
# 융창저축은행 e회전식 정기예금 (변동금리)

융창저축은행의 정기예금 상품 'e회전식 정기예금 (변동금리)' 공시 정보입니다.

> Graph-only materialization입니다. 원본 데이터는 JSON export가 authoritative source입니다.

## Metadata
- Materialized ID: `finance.deposit.deposit.0010467.243000`
- Type: `bank-product`
- provider: 융창저축은행
