---
materialized_id: "finance.deposit.deposit.0010026.01211310121"
title: "중소기업은행 IBK평생한가족통장(실세금리정기예금)"
type: "bank-product"
...
# 중소기업은행 IBK평생한가족통장(실세금리정기예금)

중소기업은행의 정기예금 상품 'IBK평생한가족통장(실세금리정기예금)' 공시 정보입니다.

> Graph-only materialization입니다. 원본 데이터는 JSON export가 authoritative source입니다.

## Metadata
- Materialized ID: `finance.deposit.deposit.0010026.01211310121`
- Type: `bank-product`
- provider: 중소기업은행
...
- related: `category.finance.source-health`, `finance.provider.3671121a35a9`, `category.finance.financial-provider-registry`, `category.finance.benchmark-rates`, `finance.benchmark-rate.bok-base-rate`
