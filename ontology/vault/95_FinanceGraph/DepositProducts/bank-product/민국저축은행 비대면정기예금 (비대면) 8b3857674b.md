---
materialized_id: "finance.bank.deposit.0010354.mk240018"
title: "민국저축은행 비대면정기예금 (비대면)"
type: "bank-product"
...
민국저축은행의 정기예금 상품 '비대면정기예금 (비대면)' 공시 정보입니다.

> Graph-only materialization입니다. 원본 데이터는 JSON export가 authoritative source입니다.

## Metadata
- Materialized ID: `finance.bank.deposit.0010354.mk240018`
- Type: `bank-product`
- provider: 민국저축은행
