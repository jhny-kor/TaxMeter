---
materialized_id: "finance.bank.deposit.0010485.401004"
title: "대명상호저축은행 E-플러스 정기예금"
type: "bank-product"
...
대명상호저축은행의 정기예금 상품 'E-플러스 정기예금' 공시 정보입니다.

> Graph-only materialization입니다. 원본 데이터는 JSON export가 authoritative source입니다.

## Metadata
- Materialized ID: `finance.bank.deposit.0010485.401004`
- Type: `bank-product`
- provider: 대명상호저축은행
