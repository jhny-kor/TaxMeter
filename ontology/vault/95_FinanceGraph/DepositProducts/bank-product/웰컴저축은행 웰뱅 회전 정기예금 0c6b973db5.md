---
materialized_id: "finance.bank.deposit.0013350.1120241011"
title: "웰컴저축은행 웰뱅 회전 정기예금"
type: "bank-product"
...
웰컴저축은행의 정기예금 상품 '웰뱅 회전 정기예금' 공시 정보입니다.

> Graph-only materialization입니다. 원본 데이터는 JSON export가 authoritative source입니다.

## Metadata
- Materialized ID: `finance.bank.deposit.0013350.1120241011`
- Type: `bank-product`
- provider: 웰컴저축은행
