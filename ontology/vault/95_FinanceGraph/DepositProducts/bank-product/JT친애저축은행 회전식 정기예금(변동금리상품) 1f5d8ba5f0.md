---
materialized_id: "finance.bank.deposit.0013308.240059"
title: "JT친애저축은행 회전식 정기예금(변동금리상품)"
type: "bank-product"
...
# JT친애저축은행 회전식 정기예금(변동금리상품)

JT친애저축은행의 정기예금 상품 '회전식 정기예금(변동금리상품)' 공시 정보입니다.

> Graph-only materialization입니다. 원본 데이터는 JSON export가 authoritative source입니다.

## Metadata
- Materialized ID: `finance.bank.deposit.0013308.240059`
- Type: `bank-product`
- provider: JT친애저축은행
