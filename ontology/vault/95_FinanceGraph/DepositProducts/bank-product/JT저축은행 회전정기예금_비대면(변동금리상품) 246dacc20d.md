---
materialized_id: "finance.bank.deposit.0011767.240048"
title: "JT저축은행 회전정기예금_비대면(변동금리상품)"
type: "bank-product"
...
# JT저축은행 회전정기예금_비대면(변동금리상품)

JT저축은행의 정기예금 상품 '회전정기예금_비대면(변동금리상품)' 공시 정보입니다.

> Graph-only materialization입니다. 원본 데이터는 JSON export가 authoritative source입니다.

## Metadata
- Materialized ID: `finance.bank.deposit.0011767.240048`
- Type: `bank-product`
- provider: JT저축은행
...
- related: `category.finance.source-health`, `finance.provider.7436798b33d0`, `category.finance.financial-provider-registry`, `category.finance.benchmark-rates`, `finance.benchmark-rate.bok-base-rate`
