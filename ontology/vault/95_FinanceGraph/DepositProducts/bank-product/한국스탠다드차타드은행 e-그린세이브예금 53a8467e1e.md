---
materialized_id: "finance.deposit.deposit.0010002.00320342"
title: "한국스탠다드차타드은행 e-그린세이브예금"
type: "bank-product"
...
한국스탠다드차타드은행의 정기예금 상품 'e-그린세이브예금' 공시 정보입니다.

> Graph-only materialization입니다. 원본 데이터는 JSON export가 authoritative source입니다.

## Metadata
- Materialized ID: `finance.deposit.deposit.0010002.00320342`
- Type: `bank-product`
