---
materialized_id: "finance.bank.deposit.0010537.240299"
title: "한국투자저축은행 한투 보이스피싱지킴이회전정기예금(창구전용)"
type: "bank-product"
...
# 한국투자저축은행 한투 보이스피싱지킴이회전정기예금(창구전용)

한국투자저축은행의 정기예금 상품 '한투 보이스피싱지킴이회전정기예금(창구전용)' 공시 정보입니다.

> Graph-only materialization입니다. 원본 데이터는 JSON export가 authoritative source입니다.

## Metadata
- Materialized ID: `finance.bank.deposit.0010537.240299`
- Type: `bank-product`
- provider: 한국투자저축은행
