---
materialized_id: "finance.bank.deposit.0010349.240801"
title: "디비저축은행 DreamBig E-정기예금"
type: "bank-product"
...
# 디비저축은행 DreamBig E-정기예금

디비저축은행의 정기예금 상품 'DreamBig E-정기예금' 공시 정보입니다.

> Graph-only materialization입니다. 원본 데이터는 JSON export가 authoritative source입니다.

## Metadata
- Materialized ID: `finance.bank.deposit.0010349.240801`
- Type: `bank-product`
- provider: 디비저축은행
