---
materialized_id: "finance.bank.deposit.0012711.24531"
title: "엔에이치저축은행 NH특판정기예금(모바일)"
type: "bank-product"
...
# 엔에이치저축은행 NH특판정기예금(모바일)

엔에이치저축은행의 정기예금 상품 'NH특판정기예금(모바일)' 공시 정보입니다.

> Graph-only materialization입니다. 원본 데이터는 JSON export가 authoritative source입니다.

## Metadata
- Materialized ID: `finance.bank.deposit.0012711.24531`
- Type: `bank-product`
- provider: 엔에이치저축은행
...
- related: `category.finance.source-health`, `finance.provider.55ea26450d00`, `category.finance.financial-provider-registry`, `category.finance.benchmark-rates`, `finance.benchmark-rate.bok-base-rate`
