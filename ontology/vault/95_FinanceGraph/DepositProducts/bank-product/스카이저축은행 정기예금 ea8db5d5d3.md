---
materialized_id: "finance.bank.deposit.0010350.240023"
title: "스카이저축은행 정기예금"
type: "bank-product"
...
스카이저축은행의 정기예금 상품 '정기예금' 공시 정보입니다.

> Graph-only materialization입니다. 원본 데이터는 JSON export가 authoritative source입니다.

## Metadata
- Materialized ID: `finance.bank.deposit.0010350.240023`
- Type: `bank-product`
- provider: 스카이저축은행
...
- related: `category.finance.source-health`, `finance.provider.727be4a9bf83`, `category.finance.financial-provider-registry`, `category.finance.benchmark-rates`, `finance.benchmark-rate.bok-base-rate`
