---
materialized_id: "finance.deposit.deposit.0010460.240017"
title: "평택저축은행 회전식정기예금"
type: "bank-product"
...
평택저축은행의 정기예금 상품 '회전식정기예금' 공시 정보입니다.

> Graph-only materialization입니다. 원본 데이터는 JSON export가 authoritative source입니다.

## Metadata
- Materialized ID: `finance.deposit.deposit.0010460.240017`
- Type: `bank-product`
- provider: 평택저축은행
...
- related: `category.finance.source-health`, `finance.provider.1e387ffd65be`, `category.finance.financial-provider-registry`, `category.finance.benchmark-rates`, `finance.benchmark-rate.bok-base-rate`
