---
materialized_id: "finance.bank.deposit.0010345.hk00011"
title: "애큐온저축은행 3-UP정기예금(모바일)"
type: "bank-product"
...
# 애큐온저축은행 3-UP정기예금(모바일)

애큐온저축은행의 정기예금 상품 '3-UP정기예금(모바일)' 공시 정보입니다.

> Graph-only materialization입니다. 원본 데이터는 JSON export가 authoritative source입니다.

## Metadata
- Materialized ID: `finance.bank.deposit.0010345.hk00011`
- Type: `bank-product`
- provider: 애큐온저축은행
...
- related: `category.finance.source-health`, `finance.provider.141fbc62d515`, `category.finance.financial-provider-registry`, `category.finance.benchmark-rates`, `finance.benchmark-rate.bok-base-rate`
