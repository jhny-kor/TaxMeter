---
materialized_id: "finance.bank.deposit.0013166.240006"
title: "하나저축은행 비대면 세바퀴정기예금(1년단위 변동금리상품)"
type: "bank-product"
...
# 하나저축은행 비대면 세바퀴정기예금(1년단위 변동금리상품)

하나저축은행의 정기예금 상품 '비대면 세바퀴정기예금(1년단위 변동금리상품)' 공시 정보입니다.

> Graph-only materialization입니다. 원본 데이터는 JSON export가 authoritative source입니다.

## Metadata
- Materialized ID: `finance.bank.deposit.0013166.240006`
- Type: `bank-product`
- provider: 하나저축은행
