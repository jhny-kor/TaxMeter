---
materialized_id: "finance.bank.deposit.0010356.1001"
title: "푸른저축은행 푸른 정기예금"
type: "bank-product"
...
푸른저축은행의 정기예금 상품 '푸른 정기예금' 공시 정보입니다.

> Graph-only materialization입니다. 원본 데이터는 JSON export가 authoritative source입니다.

## Metadata
- Materialized ID: `finance.bank.deposit.0010356.1001`
- Type: `bank-product`
- provider: 푸른저축은행
...
- related: `category.finance.source-health`, `finance.provider.d9a09595f4f5`, `category.finance.financial-provider-registry`, `category.finance.benchmark-rates`, `finance.benchmark-rate.bok-base-rate`
