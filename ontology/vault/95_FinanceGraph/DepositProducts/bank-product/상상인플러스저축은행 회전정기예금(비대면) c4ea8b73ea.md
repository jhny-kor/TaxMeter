---
materialized_id: "finance.bank.deposit.0010508.02082"
title: "상상인플러스저축은행 회전정기예금(비대면)"
type: "bank-product"
...
# 상상인플러스저축은행 회전정기예금(비대면)

상상인플러스저축은행의 정기예금 상품 '회전정기예금(비대면)' 공시 정보입니다.

> Graph-only materialization입니다. 원본 데이터는 JSON export가 authoritative source입니다.

## Metadata
- Materialized ID: `finance.bank.deposit.0010508.02082`
- Type: `bank-product`
- provider: 상상인플러스저축은행
...
- related: `category.finance.source-health`, `finance.provider.1d27b97ca91f`, `category.finance.financial-provider-registry`, `category.finance.benchmark-rates`, `finance.benchmark-rate.bok-base-rate`
