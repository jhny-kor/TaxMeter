---
materialized_id: "finance.bank.deposit.0010359.240033"
title: "키움예스저축은행 SB톡톡 정기예금(비대면)"
type: "bank-product"
...
# 키움예스저축은행 SB톡톡 정기예금(비대면)

키움예스저축은행의 정기예금 상품 'SB톡톡 정기예금(비대면)' 공시 정보입니다.

> Graph-only materialization입니다. 원본 데이터는 JSON export가 authoritative source입니다.

## Metadata
- Materialized ID: `finance.bank.deposit.0010359.240033`
- Type: `bank-product`
- provider: 키움예스저축은행
