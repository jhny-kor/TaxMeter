---
materialized_id: "finance.deposit.deposit.0010927.010300100335"
title: "국민은행 KB Star 정기예금"
type: "bank-product"
...
국민은행의 정기예금 상품 'KB Star 정기예금' 공시 정보입니다.

> Graph-only materialization입니다. 원본 데이터는 JSON export가 authoritative source입니다.

## Metadata
- Materialized ID: `finance.deposit.deposit.0010927.010300100335`
- Type: `bank-product`
- provider: 국민은행
...
- related: `category.finance.source-health`, `finance.provider.c2c9c36b8fe4`, `category.finance.financial-provider-registry`, `category.finance.benchmark-rates`, `finance.benchmark-rate.bok-base-rate`
