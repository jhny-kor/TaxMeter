---
materialized_id: "finance.bank.deposit.0010421.kh2403"
title: "금화저축은행 회전정기예금(1년단위,변동금리)"
type: "bank-product"
...
# 금화저축은행 회전정기예금(1년단위,변동금리)

금화저축은행의 정기예금 상품 '회전정기예금(1년단위,변동금리)' 공시 정보입니다.

> Graph-only materialization입니다. 원본 데이터는 JSON export가 authoritative source입니다.

## Metadata
- Materialized ID: `finance.bank.deposit.0010421.kh2403`
- Type: `bank-product`
- provider: 금화저축은행
