---
materialized_id: "finance.deposit.deposit.0010537.240198"
title: "한국투자저축은행 한투 ACE m-회전정기예금 (1년 단위 변동금리상품)"
type: "bank-product"
...
# 한국투자저축은행 한투 ACE m-회전정기예금 (1년 단위 변동금리상품)

한국투자저축은행의 정기예금 상품 '한투 ACE m-회전정기예금 (1년 단위 변동금리상품)' 공시 정보입니다.

> Graph-only materialization입니다. 원본 데이터는 JSON export가 authoritative source입니다.

## Metadata
- Materialized ID: `finance.deposit.deposit.0010537.240198`
- Type: `bank-product`
- provider: 한국투자저축은행
