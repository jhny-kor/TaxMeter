---
materialized_id: "finance.bank.deposit.0010378.240035"
title: "바로저축은행 바로6개월 정기예금(비대면)"
type: "bank-product"
...
# 바로저축은행 바로6개월 정기예금(비대면)

바로저축은행의 정기예금 상품 '바로6개월 정기예금(비대면)' 공시 정보입니다.

> Graph-only materialization입니다. 원본 데이터는 JSON export가 authoritative source입니다.

## Metadata
- Materialized ID: `finance.bank.deposit.0010378.240035`
- Type: `bank-product`
- provider: 바로저축은행
