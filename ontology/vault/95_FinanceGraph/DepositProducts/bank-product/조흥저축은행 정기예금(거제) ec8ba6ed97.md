---
materialized_id: "finance.deposit.deposit.0010575.jh0002a"
title: "조흥저축은행 정기예금(거제)"
type: "bank-product"
...
조흥저축은행의 정기예금 상품 '정기예금(거제)' 공시 정보입니다.

> Graph-only materialization입니다. 원본 데이터는 JSON export가 authoritative source입니다.

## Metadata
- Materialized ID: `finance.deposit.deposit.0010575.jh0002a`
- Type: `bank-product`
- provider: 조흥저축은행
...
- related: `category.finance.source-health`, `finance.provider.90a2616df988`, `category.finance.financial-provider-registry`, `category.finance.benchmark-rates`, `finance.benchmark-rate.bok-base-rate`
