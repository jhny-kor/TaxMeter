---
materialized_id: "finance.deposit.deposit.0017801.1001202000002"
title: "토스뱅크 주식회사 토스뱅크 먼저 이자 받는 정기예금"
type: "bank-product"
...
# 토스뱅크 주식회사 토스뱅크 먼저 이자 받는 정기예금

토스뱅크 주식회사의 정기예금 상품 '토스뱅크 먼저 이자 받는 정기예금' 공시 정보입니다.

> Graph-only materialization입니다. 원본 데이터는 JSON export가 authoritative source입니다.

## Metadata
- Materialized ID: `finance.deposit.deposit.0017801.1001202000002`
- Type: `bank-product`
- provider: 토스뱅크 주식회사
...
- related: `category.finance.source-health`, `finance.provider.d77a5277f881`, `category.finance.financial-provider-registry`, `category.finance.benchmark-rates`, `finance.benchmark-rate.bok-base-rate`
