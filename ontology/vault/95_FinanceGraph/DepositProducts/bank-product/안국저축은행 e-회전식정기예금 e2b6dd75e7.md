---
materialized_id: "finance.deposit.deposit.0010448.24-0005"
title: "안국저축은행 e-회전식정기예금"
type: "bank-product"
...
안국저축은행의 정기예금 상품 'e-회전식정기예금' 공시 정보입니다.

> Graph-only materialization입니다. 원본 데이터는 JSON export가 authoritative source입니다.

## Metadata
- Materialized ID: `finance.deposit.deposit.0010448.24-0005`
- Type: `bank-product`
- provider: 안국저축은행
