---
materialized_id: "finance.bank.deposit.0010416.240001"
title: "흥국저축은행 정기예금(부산)"
type: "bank-product"
...
흥국저축은행의 정기예금 상품 '정기예금(부산)' 공시 정보입니다.

> Graph-only materialization입니다. 원본 데이터는 JSON export가 authoritative source입니다.

## Metadata
- Materialized ID: `finance.bank.deposit.0010416.240001`
- Type: `bank-product`
- provider: 흥국저축은행
