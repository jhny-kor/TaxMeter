---
materialized_id: "finance.deposit.deposit.0010024.21001115"
title: "경남은행 BNK더조은정기예금"
type: "bank-product"
...
경남은행의 정기예금 상품 'BNK더조은정기예금' 공시 정보입니다.

> Graph-only materialization입니다. 원본 데이터는 JSON export가 authoritative source입니다.

## Metadata
- Materialized ID: `finance.deposit.deposit.0010024.21001115`
- Type: `bank-product`
- provider: 경남은행
...
- related: `category.finance.source-health`, `finance.provider.57458793d901`, `category.finance.financial-provider-registry`, `category.finance.benchmark-rates`, `finance.benchmark-rate.bok-base-rate`
