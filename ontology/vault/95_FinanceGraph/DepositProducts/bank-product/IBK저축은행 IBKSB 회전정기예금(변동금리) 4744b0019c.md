---
materialized_id: "finance.bank.deposit.0012889.240074"
title: "IBK저축은행 IBKSB 회전정기예금(변동금리)"
type: "bank-product"
...
# IBK저축은행 IBKSB 회전정기예금(변동금리)

IBK저축은행의 정기예금 상품 'IBKSB 회전정기예금(변동금리)' 공시 정보입니다.

> Graph-only materialization입니다. 원본 데이터는 JSON export가 authoritative source입니다.

## Metadata
- Materialized ID: `finance.bank.deposit.0012889.240074`
- Type: `bank-product`
- provider: IBK저축은행
