---
materialized_id: "finance.bank.deposit.0013166.240010"
title: "하나저축은행 비대면 하나더넥스트 시니어 회전예금"
type: "bank-product"
...
# 하나저축은행 비대면 하나더넥스트 시니어 회전예금

하나저축은행의 정기예금 상품 '비대면 하나더넥스트 시니어 회전예금' 공시 정보입니다.

> Graph-only materialization입니다. 원본 데이터는 JSON export가 authoritative source입니다.

## Metadata
- Materialized ID: `finance.bank.deposit.0013166.240010`
- Type: `bank-product`
- provider: 하나저축은행
