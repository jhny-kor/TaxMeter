---
materialized_id: "finance.bank.deposit.0010390.240038"
title: "고려저축은행 정기예금(비대면)"
type: "bank-product"
...
고려저축은행의 정기예금 상품 '정기예금(비대면)' 공시 정보입니다.

> Graph-only materialization입니다. 원본 데이터는 JSON export가 authoritative source입니다.

## Metadata
- Materialized ID: `finance.bank.deposit.0010390.240038`
- Type: `bank-product`
- provider: 고려저축은행
