---
materialized_id: "finance.bank.deposit.0010456.240056"
title: "키움저축은행 SB톡톡 회전식정기예금(비대면) (1년단위 변동금리상품)"
type: "bank-product"
...
# 키움저축은행 SB톡톡 회전식정기예금(비대면) (1년단위 변동금리상품)

키움저축은행의 정기예금 상품 'SB톡톡 회전식정기예금(비대면) (1년단위 변동금리상품)' 공시 정보입니다.

> Graph-only materialization입니다. 원본 데이터는 JSON export가 authoritative source입니다.

## Metadata
- Materialized ID: `finance.bank.deposit.0010456.240056`
- Type: `bank-product`
- provider: 키움저축은행
