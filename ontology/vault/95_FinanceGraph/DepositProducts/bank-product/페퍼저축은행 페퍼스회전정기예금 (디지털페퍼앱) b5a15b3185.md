---
materialized_id: "finance.bank.deposit.0010471.24-0081"
title: "페퍼저축은행 페퍼스회전정기예금 (디지털페퍼앱)"
type: "bank-product"
...
# 페퍼저축은행 페퍼스회전정기예금 (디지털페퍼앱)

페퍼저축은행의 정기예금 상품 '페퍼스회전정기예금 (디지털페퍼앱)' 공시 정보입니다.

> Graph-only materialization입니다. 원본 데이터는 JSON export가 authoritative source입니다.

## Metadata
- Materialized ID: `finance.bank.deposit.0010471.24-0081`
- Type: `bank-product`
- provider: 페퍼저축은행
