---
materialized_id: "finance.deposit.deposit.0010030.06492"
title: "한국산업은행 KDB 정기예금"
type: "bank-product"
...
한국산업은행의 정기예금 상품 'KDB 정기예금' 공시 정보입니다.

> Graph-only materialization입니다. 원본 데이터는 JSON export가 authoritative source입니다.

## Metadata
- Materialized ID: `finance.deposit.deposit.0010030.06492`
- Type: `bank-product`
- provider: 한국산업은행
...
- related: `category.finance.source-health`, `finance.provider.a557c697c591`, `category.finance.financial-provider-registry`, `category.finance.benchmark-rates`, `finance.benchmark-rate.bok-base-rate`
