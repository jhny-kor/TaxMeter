---
materialized_id: "finance.bank.deposit.0010526.240010-240011"
title: "대한저축은행 정기예금(인터넷뱅킹)"
type: "bank-product"
...
대한저축은행의 정기예금 상품 '정기예금(인터넷뱅킹)' 공시 정보입니다.

> Graph-only materialization입니다. 원본 데이터는 JSON export가 authoritative source입니다.

## Metadata
- Materialized ID: `finance.bank.deposit.0010526.240010-240011`
- Type: `bank-product`
- provider: 대한저축은행
