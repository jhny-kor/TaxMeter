---
materialized_id: "finance.bank.deposit.0010388.240046"
title: "다올저축은행 Fi 정기예금 (비대면)"
type: "bank-product"
...
다올저축은행의 정기예금 상품 'Fi 정기예금 (비대면)' 공시 정보입니다.

> Graph-only materialization입니다. 원본 데이터는 JSON export가 authoritative source입니다.

## Metadata
- Materialized ID: `finance.bank.deposit.0010388.240046`
- Type: `bank-product`
- provider: 다올저축은행
