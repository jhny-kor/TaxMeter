---
materialized_id: "finance.deposit.deposit.0010019.td11300031000"
title: "광주은행 스마트모아Dream정기예금"
type: "bank-product"
...
광주은행의 정기예금 상품 '스마트모아Dream정기예금' 공시 정보입니다.

> Graph-only materialization입니다. 원본 데이터는 JSON export가 authoritative source입니다.

## Metadata
- Materialized ID: `finance.deposit.deposit.0010019.td11300031000`
- Type: `bank-product`
- provider: 광주은행
...
- related: `category.finance.source-health`, `finance.provider.acc6bde27a68`, `category.finance.financial-provider-registry`, `category.finance.benchmark-rates`, `finance.benchmark-rate.bok-base-rate`
