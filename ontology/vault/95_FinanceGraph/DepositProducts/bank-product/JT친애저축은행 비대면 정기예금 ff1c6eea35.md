---
materialized_id: "finance.deposit.deposit.0013308.jtcsb240060"
title: "JT친애저축은행 비대면 정기예금"
type: "bank-product"
...
JT친애저축은행의 정기예금 상품 '비대면 정기예금' 공시 정보입니다.

> Graph-only materialization입니다. 원본 데이터는 JSON export가 authoritative source입니다.

## Metadata
- Materialized ID: `finance.deposit.deposit.0013308.jtcsb240060`
- Type: `bank-product`
- provider: JT친애저축은행
