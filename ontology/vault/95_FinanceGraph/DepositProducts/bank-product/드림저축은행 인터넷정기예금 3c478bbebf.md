---
materialized_id: "finance.deposit.deposit.0010551.240007"
title: "드림저축은행 인터넷정기예금"
type: "bank-product"
...
드림저축은행의 정기예금 상품 '인터넷정기예금' 공시 정보입니다.

> Graph-only materialization입니다. 원본 데이터는 JSON export가 authoritative source입니다.

## Metadata
- Materialized ID: `finance.deposit.deposit.0010551.240007`
- Type: `bank-product`
- provider: 드림저축은행
