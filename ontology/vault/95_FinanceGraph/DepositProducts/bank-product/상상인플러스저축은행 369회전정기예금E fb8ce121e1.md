---
materialized_id: "finance.bank.deposit.0010508.02085"
title: "상상인플러스저축은행 369회전정기예금E"
type: "bank-product"
...
상상인플러스저축은행의 정기예금 상품 '369회전정기예금E' 공시 정보입니다.

> Graph-only materialization입니다. 원본 데이터는 JSON export가 authoritative source입니다.

## Metadata
- Materialized ID: `finance.bank.deposit.0010508.02085`
- Type: `bank-product`
- provider: 상상인플러스저축은행
