---
materialized_id: "finance.bank.deposit.0010024.21001280"
title: "경남은행 The든든예금(시즌2)"
type: "bank-product"
...
경남은행의 정기예금 상품 'The든든예금(시즌2)' 공시 정보입니다.

> Graph-only materialization입니다. 원본 데이터는 JSON export가 authoritative source입니다.

## Metadata
- Materialized ID: `finance.bank.deposit.0010024.21001280`
- Type: `bank-product`
- provider: 경남은행
