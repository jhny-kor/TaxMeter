---
materialized_id: "finance.bank.deposit.0010489.240022"
title: "청주저축은행 정기예금_천안지점"
type: "bank-product"
...
청주저축은행의 정기예금 상품 '정기예금_천안지점' 공시 정보입니다.

> Graph-only materialization입니다. 원본 데이터는 JSON export가 authoritative source입니다.

## Metadata
- Materialized ID: `finance.bank.deposit.0010489.240022`
- Type: `bank-product`
- provider: 청주저축은행
