---
materialized_id: "finance.bank.deposit.0010478.240010"
title: "CK저축은행 정기예금(춘천본점)"
type: "bank-product"
...
CK저축은행의 정기예금 상품 '정기예금(춘천본점)' 공시 정보입니다.

> Graph-only materialization입니다. 원본 데이터는 JSON export가 authoritative source입니다.

## Metadata
- Materialized ID: `finance.bank.deposit.0010478.240010`
- Type: `bank-product`
- provider: CK저축은행
