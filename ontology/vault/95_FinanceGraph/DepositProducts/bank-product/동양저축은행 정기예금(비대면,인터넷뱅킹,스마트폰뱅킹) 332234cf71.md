---
materialized_id: "finance.bank.deposit.0010527.240014"
title: "동양저축은행 정기예금(비대면,인터넷뱅킹,스마트폰뱅킹)"
type: "bank-product"
...
동양저축은행의 정기예금 상품 '정기예금(비대면,인터넷뱅킹,스마트폰뱅킹)' 공시 정보입니다.

> Graph-only materialization입니다. 원본 데이터는 JSON export가 authoritative source입니다.

## Metadata
- Materialized ID: `finance.bank.deposit.0010527.240014`
- Type: `bank-product`
- provider: 동양저축은행
...
- related: `category.finance.source-health`, `finance.provider.032510c7bfee`, `category.finance.financial-provider-registry`, `category.finance.benchmark-rates`, `finance.benchmark-rate.bok-base-rate`
