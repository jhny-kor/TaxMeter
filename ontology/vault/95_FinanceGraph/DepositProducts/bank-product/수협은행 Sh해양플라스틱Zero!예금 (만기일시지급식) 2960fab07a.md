---
materialized_id: "finance.bank.deposit.0014807.10120114300011"
title: "수협은행 Sh해양플라스틱Zero!예금\n(만기일시지급식)"
type: "bank-product"
...
수협은행의 정기예금 상품 'Sh해양플라스틱Zero!예금
(만기일시지급식)' 공시 정보입니다.

> Graph-only materialization입니다. 원본 데이터는 JSON export가 authoritative source입니다.

## Metadata
- Materialized ID: `finance.bank.deposit.0014807.10120114300011`
- Type: `bank-product`
- provider: 수협은행
