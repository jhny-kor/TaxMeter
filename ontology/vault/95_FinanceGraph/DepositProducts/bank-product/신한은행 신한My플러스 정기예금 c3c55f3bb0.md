---
materialized_id: "finance.bank.deposit.0011625.207-0134-16"
title: "신한은행 신한My플러스 정기예금"
type: "bank-product"
...
신한은행의 정기예금 상품 '신한My플러스 정기예금' 공시 정보입니다.

> Graph-only materialization입니다. 원본 데이터는 JSON export가 authoritative source입니다.

## Metadata
- Materialized ID: `finance.bank.deposit.0011625.207-0134-16`
- Type: `bank-product`
- provider: 신한은행
...
- related: `category.finance.source-health`, `finance.provider.ae7f6cc47c20`, `category.finance.financial-provider-registry`, `category.finance.benchmark-rates`, `finance.benchmark-rate.bok-base-rate`
