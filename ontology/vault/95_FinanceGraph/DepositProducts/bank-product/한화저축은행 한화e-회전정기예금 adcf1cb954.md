---
materialized_id: "finance.deposit.deposit.0010477.240109"
title: "한화저축은행 한화e-회전정기예금"
type: "bank-product"
...
한화저축은행의 정기예금 상품 '한화e-회전정기예금' 공시 정보입니다.

> Graph-only materialization입니다. 원본 데이터는 JSON export가 authoritative source입니다.

## Metadata
- Materialized ID: `finance.deposit.deposit.0010477.240109`
- Type: `bank-product`
- provider: 한화저축은행
