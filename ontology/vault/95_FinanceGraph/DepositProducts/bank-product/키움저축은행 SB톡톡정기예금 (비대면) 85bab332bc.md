---
materialized_id: "finance.deposit.deposit.0010456.240029"
title: "키움저축은행 SB톡톡정기예금 (비대면)"
type: "bank-product"
...
키움저축은행의 정기예금 상품 'SB톡톡정기예금 (비대면)' 공시 정보입니다.

> Graph-only materialization입니다. 원본 데이터는 JSON export가 authoritative source입니다.

## Metadata
- Materialized ID: `finance.deposit.deposit.0010456.240029`
- Type: `bank-product`
- provider: 키움저축은행
