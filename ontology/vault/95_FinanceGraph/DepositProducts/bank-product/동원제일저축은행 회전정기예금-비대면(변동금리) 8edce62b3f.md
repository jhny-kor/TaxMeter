---
materialized_id: "finance.bank.deposit.0010574.240018"
title: "동원제일저축은행 회전정기예금-비대면(변동금리)"
type: "bank-product"
...
동원제일저축은행의 정기예금 상품 '회전정기예금-비대면(변동금리)' 공시 정보입니다.

> Graph-only materialization입니다. 원본 데이터는 JSON export가 authoritative source입니다.

## Metadata
- Materialized ID: `finance.bank.deposit.0010574.240018`
- Type: `bank-product`
- provider: 동원제일저축은행
...
- related: `category.finance.source-health`, `finance.provider.e810767a8316`, `category.finance.financial-provider-registry`, `category.finance.benchmark-rates`, `finance.benchmark-rate.bok-base-rate`
