---
materialized_id: "finance.bank.saving.0010022.10-01-30-031-0036"
title: "전북은행 JB 다이렉트적금(정액적립식)"
type: "bank-product"
...
# 전북은행 JB 다이렉트적금(정액적립식)

전북은행의 적금 상품 'JB 다이렉트적금(정액적립식)' 공시 정보입니다.

> Graph-only materialization입니다. 원본 데이터는 JSON export가 authoritative source입니다.

## Metadata
- Materialized ID: `finance.bank.saving.0010022.10-01-30-031-0036`
- Type: `bank-product`
- provider: 전북은행
