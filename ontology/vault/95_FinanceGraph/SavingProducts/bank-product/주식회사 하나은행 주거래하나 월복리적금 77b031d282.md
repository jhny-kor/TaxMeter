---
materialized_id: "finance.bank.saving.0013909.52"
title: "주식회사 하나은행 주거래하나 월복리적금"
type: "bank-product"
...
# 주식회사 하나은행 주거래하나 월복리적금

주식회사 하나은행의 적금 상품 '주거래하나 월복리적금' 공시 정보입니다.

> Graph-only materialization입니다. 원본 데이터는 JSON export가 authoritative source입니다.

## Metadata
- Materialized ID: `finance.bank.saving.0013909.52`
- Type: `bank-product`
- provider: 주식회사 하나은행
...
- related: `category.finance.source-health`, `finance.provider.0f96cb9fa06a`, `category.finance.financial-provider-registry`, `category.finance.benchmark-rates`, `finance.benchmark-rate.bok-base-rate`
