---
materialized_id: "finance.bank.saving.0010437.310006"
title: "대백저축은행 꿈나무정기적금"
type: "bank-product"
...
대백저축은행의 적금 상품 '꿈나무정기적금' 공시 정보입니다.

> Graph-only materialization입니다. 원본 데이터는 JSON export가 authoritative source입니다.

## Metadata
- Materialized ID: `finance.bank.saving.0010437.310006`
- Type: `bank-product`
- provider: 대백저축은행
...
- related: `category.finance.source-health`, `finance.provider.10457adf0e05`, `category.finance.financial-provider-registry`, `category.finance.benchmark-rates`, `finance.benchmark-rate.bok-base-rate`
