---
materialized_id: "finance.bank.saving.0010390.310017"
title: "고려저축은행 마이버킷정기적금"
type: "bank-product"
...
고려저축은행의 적금 상품 '마이버킷정기적금' 공시 정보입니다.

> Graph-only materialization입니다. 원본 데이터는 JSON export가 authoritative source입니다.

## Metadata
- Materialized ID: `finance.bank.saving.0010390.310017`
- Type: `bank-product`
- provider: 고려저축은행
