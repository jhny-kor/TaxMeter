---
materialized_id: "finance.saving.saving.0010473.gp310017"
title: "상상인저축은행 비대면 정기적금"
type: "bank-product"
...
상상인저축은행의 적금 상품 '비대면 정기적금' 공시 정보입니다.

> Graph-only materialization입니다. 원본 데이터는 JSON export가 authoritative source입니다.

## Metadata
- Materialized ID: `finance.saving.saving.0010473.gp310017`
- Type: `bank-product`
- provider: 상상인저축은행
