---
materialized_id: "finance.bank.saving.0014807.10141114300011"
title: "수협은행 Sh해양플라스틱Zero!적금\n(자유적립식)"
type: "bank-product"
...
수협은행의 적금 상품 'Sh해양플라스틱Zero!적금
(자유적립식)' 공시 정보입니다.

> Graph-only materialization입니다. 원본 데이터는 JSON export가 authoritative source입니다.

## Metadata
- Materialized ID: `finance.bank.saving.0014807.10141114300011`
- Type: `bank-product`
- provider: 수협은행
