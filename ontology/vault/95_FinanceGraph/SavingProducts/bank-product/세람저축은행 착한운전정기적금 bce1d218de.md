---
materialized_id: "finance.bank.saving.0010468.310052"
title: "세람저축은행 착한운전정기적금"
type: "bank-product"
...
세람저축은행의 적금 상품 '착한운전정기적금' 공시 정보입니다.

> Graph-only materialization입니다. 원본 데이터는 JSON export가 authoritative source입니다.

## Metadata
- Materialized ID: `finance.bank.saving.0010468.310052`
- Type: `bank-product`
- provider: 세람저축은행
...
- related: `category.finance.source-health`, `finance.provider.978bfaf9aa7d`, `category.finance.financial-provider-registry`, `category.finance.benchmark-rates`, `finance.benchmark-rate.bok-base-rate`
