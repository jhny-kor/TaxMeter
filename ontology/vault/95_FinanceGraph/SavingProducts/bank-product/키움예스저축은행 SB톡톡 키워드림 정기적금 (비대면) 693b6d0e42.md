---
materialized_id: "finance.bank.saving.0010359.310007"
title: "키움예스저축은행 SB톡톡 키워드림 정기적금 (비대면)"
type: "bank-product"
...
# 키움예스저축은행 SB톡톡 키워드림 정기적금 (비대면)

키움예스저축은행의 적금 상품 'SB톡톡 키워드림 정기적금 (비대면)' 공시 정보입니다.

> Graph-only materialization입니다. 원본 데이터는 JSON export가 authoritative source입니다.

## Metadata
- Materialized ID: `finance.bank.saving.0010359.310007`
- Type: `bank-product`
- provider: 키움예스저축은행
