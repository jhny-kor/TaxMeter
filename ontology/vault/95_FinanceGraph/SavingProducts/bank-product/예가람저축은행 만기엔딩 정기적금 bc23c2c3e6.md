---
materialized_id: "finance.bank.saving.0011551.310020"
title: "예가람저축은행 만기엔딩 정기적금"
type: "bank-product"
...
예가람저축은행의 적금 상품 '만기엔딩 정기적금' 공시 정보입니다.

> Graph-only materialization입니다. 원본 데이터는 JSON export가 authoritative source입니다.

## Metadata
- Materialized ID: `finance.bank.saving.0011551.310020`
- Type: `bank-product`
- provider: 예가람저축은행
