---
materialized_id: "finance.bank.saving.0010345.hk00102"
title: "애큐온저축은행 애(愛)랑해적금"
type: "bank-product"
...
애큐온저축은행의 적금 상품 '애(愛)랑해적금' 공시 정보입니다.

> Graph-only materialization입니다. 원본 데이터는 JSON export가 authoritative source입니다.

## Metadata
- Materialized ID: `finance.bank.saving.0010345.hk00102`
- Type: `bank-product`
- provider: 애큐온저축은행
