---
materialized_id: "finance.bank.saving.0010533.310005"
title: "센트럴저축은행 정기적금 (인터넷뱅킹,스마트뱅킹,비대면)"
type: "bank-product"
...
# 센트럴저축은행 정기적금 (인터넷뱅킹,스마트뱅킹,비대면)

센트럴저축은행의 적금 상품 '정기적금 (인터넷뱅킹,스마트뱅킹,비대면)' 공시 정보입니다.

> Graph-only materialization입니다. 원본 데이터는 JSON export가 authoritative source입니다.

## Metadata
- Materialized ID: `finance.bank.saving.0010533.310005`
- Type: `bank-product`
- provider: 센트럴저축은행
