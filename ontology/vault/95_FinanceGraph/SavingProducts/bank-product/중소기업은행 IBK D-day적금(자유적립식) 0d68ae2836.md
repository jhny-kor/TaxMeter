---
materialized_id: "finance.bank.saving.0010026.01211210113"
title: "중소기업은행 IBK D-day적금(자유적립식)"
type: "bank-product"
...
# 중소기업은행 IBK D-day적금(자유적립식)

중소기업은행의 적금 상품 'IBK D-day적금(자유적립식)' 공시 정보입니다.

> Graph-only materialization입니다. 원본 데이터는 JSON export가 authoritative source입니다.

## Metadata
- Materialized ID: `finance.bank.saving.0010026.01211210113`
- Type: `bank-product`
- provider: 중소기업은행
