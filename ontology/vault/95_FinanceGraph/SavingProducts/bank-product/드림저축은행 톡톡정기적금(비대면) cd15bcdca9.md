---
materialized_id: "finance.bank.saving.0010551.310018"
title: "드림저축은행 톡톡정기적금(비대면)"
type: "bank-product"
...
드림저축은행의 적금 상품 '톡톡정기적금(비대면)' 공시 정보입니다.

> Graph-only materialization입니다. 원본 데이터는 JSON export가 authoritative source입니다.

## Metadata
- Materialized ID: `finance.bank.saving.0010551.310018`
- Type: `bank-product`
- provider: 드림저축은행
...
- related: `category.finance.source-health`, `finance.provider.c5a404a84318`, `category.finance.financial-provider-registry`, `category.finance.benchmark-rates`, `finance.benchmark-rate.bok-base-rate`
