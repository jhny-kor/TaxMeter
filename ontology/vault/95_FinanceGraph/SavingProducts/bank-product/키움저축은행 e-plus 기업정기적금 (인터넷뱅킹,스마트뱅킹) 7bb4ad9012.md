---
materialized_id: "finance.bank.saving.0010456.310012"
title: "키움저축은행 e-plus 기업정기적금 (인터넷뱅킹,스마트뱅킹)"
type: "bank-product"
...
# 키움저축은행 e-plus 기업정기적금 (인터넷뱅킹,스마트뱅킹)

키움저축은행의 적금 상품 'e-plus 기업정기적금 (인터넷뱅킹,스마트뱅킹)' 공시 정보입니다.

> Graph-only materialization입니다. 원본 데이터는 JSON export가 authoritative source입니다.

## Metadata
- Materialized ID: `finance.bank.saving.0010456.310012`
- Type: `bank-product`
- provider: 키움저축은행
...
- related: `category.finance.source-health`, `finance.provider.5a813ee0fab2`, `category.finance.financial-provider-registry`, `category.finance.benchmark-rates`, `finance.benchmark-rate.bok-base-rate`
