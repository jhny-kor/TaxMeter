---
materialized_id: "finance.bank.saving.0010349.310820"
title: "디비저축은행 DB행복씨앗적금"
type: "bank-product"
...
디비저축은행의 적금 상품 'DB행복씨앗적금' 공시 정보입니다.

> Graph-only materialization입니다. 원본 데이터는 JSON export가 authoritative source입니다.

## Metadata
- Materialized ID: `finance.bank.saving.0010349.310820`
- Type: `bank-product`
- provider: 디비저축은행
