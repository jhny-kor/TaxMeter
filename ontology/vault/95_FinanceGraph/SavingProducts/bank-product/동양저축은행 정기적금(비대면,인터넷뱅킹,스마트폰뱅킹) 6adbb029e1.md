---
materialized_id: "finance.bank.saving.0010527.310007"
title: "동양저축은행 정기적금(비대면,인터넷뱅킹,스마트폰뱅킹)"
type: "bank-product"
...
동양저축은행의 적금 상품 '정기적금(비대면,인터넷뱅킹,스마트폰뱅킹)' 공시 정보입니다.

> Graph-only materialization입니다. 원본 데이터는 JSON export가 authoritative source입니다.

## Metadata
- Materialized ID: `finance.bank.saving.0010527.310007`
- Type: `bank-product`
- provider: 동양저축은행
