---
materialized_id: "finance.bank.saving.0010448.31-0003"
title: "안국저축은행 정기적금(비대면)"
type: "bank-product"
...
안국저축은행의 적금 상품 '정기적금(비대면)' 공시 정보입니다.

> Graph-only materialization입니다. 원본 데이터는 JSON export가 authoritative source입니다.

## Metadata
- Materialized ID: `finance.bank.saving.0010448.31-0003`
- Type: `bank-product`
- provider: 안국저축은행
