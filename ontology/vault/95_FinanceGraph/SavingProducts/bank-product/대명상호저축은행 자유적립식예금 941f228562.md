---
materialized_id: "finance.bank.saving.0010485.310009"
title: "대명상호저축은행 자유적립식예금"
type: "bank-product"
...
대명상호저축은행의 적금 상품 '자유적립식예금' 공시 정보입니다.

> Graph-only materialization입니다. 원본 데이터는 JSON export가 authoritative source입니다.

## Metadata
- Materialized ID: `finance.bank.saving.0010485.310009`
- Type: `bank-product`
- provider: 대명상호저축은행
