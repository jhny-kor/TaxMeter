---
materialized_id: "finance.bank.saving.0010460.310013"
title: "평택저축은행 정기적금-모바일"
type: "bank-product"
...
평택저축은행의 적금 상품 '정기적금-모바일' 공시 정보입니다.

> Graph-only materialization입니다. 원본 데이터는 JSON export가 authoritative source입니다.

## Metadata
- Materialized ID: `finance.bank.saving.0010460.310013`
- Type: `bank-product`
- provider: 평택저축은행
