---
materialized_id: "finance.bank.saving.0010430.310037"
title: "모아저축은행 생일축하정기적금"
type: "bank-product"
...
모아저축은행의 적금 상품 '생일축하정기적금' 공시 정보입니다.

> Graph-only materialization입니다. 원본 데이터는 JSON export가 authoritative source입니다.

## Metadata
- Materialized ID: `finance.bank.saving.0010430.310037`
- Type: `bank-product`
- provider: 모아저축은행
