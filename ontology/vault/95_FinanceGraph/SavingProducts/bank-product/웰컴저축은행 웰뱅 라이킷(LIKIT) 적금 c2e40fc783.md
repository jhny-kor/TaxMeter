---
materialized_id: "finance.bank.saving.0013350.1130313563"
title: "웰컴저축은행 웰뱅 라이킷(LIKIT) 적금"
type: "bank-product"
...
웰컴저축은행의 적금 상품 '웰뱅 라이킷(LIKIT) 적금' 공시 정보입니다.

> Graph-only materialization입니다. 원본 데이터는 JSON export가 authoritative source입니다.

## Metadata
- Materialized ID: `finance.bank.saving.0013350.1130313563`
- Type: `bank-product`
- provider: 웰컴저축은행
