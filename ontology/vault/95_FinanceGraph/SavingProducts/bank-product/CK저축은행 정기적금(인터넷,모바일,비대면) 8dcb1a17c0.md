---
materialized_id: "finance.bank.saving.0010478.310005"
title: "CK저축은행 정기적금(인터넷,모바일,비대면)"
type: "bank-product"
...
# CK저축은행 정기적금(인터넷,모바일,비대면)

CK저축은행의 적금 상품 '정기적금(인터넷,모바일,비대면)' 공시 정보입니다.

> Graph-only materialization입니다. 원본 데이터는 JSON export가 authoritative source입니다.

## Metadata
- Materialized ID: `finance.bank.saving.0010478.310005`
- Type: `bank-product`
- provider: CK저축은행
...
- related: `category.finance.source-health`, `finance.provider.981bfd41aff5`, `category.finance.financial-provider-registry`, `category.finance.benchmark-rates`, `finance.benchmark-rate.bok-base-rate`
