---
materialized_id: "finance.saving.saving.0010391.kj0004b"
title: "국제저축은행 꿈 찾아 정기적금(비대면)"
type: "bank-product"
...
# 국제저축은행 꿈 찾아 정기적금(비대면)

국제저축은행의 적금 상품 '꿈 찾아 정기적금(비대면)' 공시 정보입니다.

> Graph-only materialization입니다. 원본 데이터는 JSON export가 authoritative source입니다.

## Metadata
- Materialized ID: `finance.saving.saving.0010391.kj0004b`
- Type: `bank-product`
- provider: 국제저축은행
