---
materialized_id: "finance.bank.saving.0010556.310008"
title: "머스트삼일저축은행 정기적금"
type: "bank-product"
...
머스트삼일저축은행의 적금 상품 '정기적금' 공시 정보입니다.

> Graph-only materialization입니다. 원본 데이터는 JSON export가 authoritative source입니다.

## Metadata
- Materialized ID: `finance.bank.saving.0010556.310008`
- Type: `bank-product`
- provider: 머스트삼일저축은행
