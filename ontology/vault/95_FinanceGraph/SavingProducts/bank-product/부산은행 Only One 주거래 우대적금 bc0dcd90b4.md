---
materialized_id: "finance.bank.saving.0010017.01020400700001"
title: "부산은행 Only One 주거래 우대적금"
type: "bank-product"
...
# 부산은행 Only One 주거래 우대적금

부산은행의 적금 상품 'Only One 주거래 우대적금' 공시 정보입니다.

> Graph-only materialization입니다. 원본 데이터는 JSON export가 authoritative source입니다.

## Metadata
- Materialized ID: `finance.bank.saving.0010017.01020400700001`
- Type: `bank-product`
- provider: 부산은행
...
- related: `category.finance.source-health`, `finance.provider.48706dc41f6c`, `category.finance.financial-provider-registry`, `category.finance.benchmark-rates`, `finance.benchmark-rate.bok-base-rate`
