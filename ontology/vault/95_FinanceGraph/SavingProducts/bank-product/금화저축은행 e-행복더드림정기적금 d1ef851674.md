---
materialized_id: "finance.bank.saving.0010421.kh3102"
title: "금화저축은행 e-행복더드림정기적금"
type: "bank-product"
...
금화저축은행의 적금 상품 'e-행복더드림정기적금' 공시 정보입니다.

> Graph-only materialization입니다. 원본 데이터는 JSON export가 authoritative source입니다.

## Metadata
- Materialized ID: `finance.bank.saving.0010421.kh3102`
- Type: `bank-product`
- provider: 금화저축은행
