---
materialized_id: "finance.bank.saving.0012711.31535"
title: "엔에이치저축은행 NH 친환경 행복플러스 정기적금"
type: "bank-product"
...
# 엔에이치저축은행 NH 친환경 행복플러스 정기적금

엔에이치저축은행의 적금 상품 'NH 친환경 행복플러스 정기적금' 공시 정보입니다.

> Graph-only materialization입니다. 원본 데이터는 JSON export가 authoritative source입니다.

## Metadata
- Materialized ID: `finance.bank.saving.0012711.31535`
- Type: `bank-product`
- provider: 엔에이치저축은행
