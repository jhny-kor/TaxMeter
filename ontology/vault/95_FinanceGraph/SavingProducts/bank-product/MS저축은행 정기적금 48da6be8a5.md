---
materialized_id: "finance.bank.saving.0010439.310008"
title: "MS저축은행 정기적금"
type: "bank-product"
...
MS저축은행의 적금 상품 '정기적금' 공시 정보입니다.

> Graph-only materialization입니다. 원본 데이터는 JSON export가 authoritative source입니다.

## Metadata
- Materialized ID: `finance.bank.saving.0010439.310008`
- Type: `bank-product`
- provider: MS저축은행
...
- related: `category.finance.source-health`, `finance.provider.86835c29c93d`, `category.finance.financial-provider-registry`, `category.finance.benchmark-rates`, `finance.benchmark-rate.bok-base-rate`
