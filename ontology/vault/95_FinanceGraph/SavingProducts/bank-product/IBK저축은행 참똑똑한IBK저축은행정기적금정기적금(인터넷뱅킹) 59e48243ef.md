---
materialized_id: "finance.bank.saving.0012889.310041"
title: "IBK저축은행 참똑똑한IBK저축은행정기적금정기적금(인터넷뱅킹)"
type: "bank-product"
...
# IBK저축은행 참똑똑한IBK저축은행정기적금정기적금(인터넷뱅킹)

IBK저축은행의 적금 상품 '참똑똑한IBK저축은행정기적금정기적금(인터넷뱅킹)' 공시 정보입니다.

> Graph-only materialization입니다. 원본 데이터는 JSON export가 authoritative source입니다.

## Metadata
- Materialized ID: `finance.bank.saving.0012889.310041`
- Type: `bank-product`
- provider: IBK저축은행
...
- related: `category.finance.source-health`, `finance.provider.0b71d3b1393a`, `category.finance.financial-provider-registry`, `category.finance.benchmark-rates`, `finance.benchmark-rate.bok-base-rate`
