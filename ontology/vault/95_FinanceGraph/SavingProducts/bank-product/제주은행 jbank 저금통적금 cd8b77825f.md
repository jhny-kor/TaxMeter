---
materialized_id: "finance.bank.saving.0010020.220002101"
title: "제주은행 jbank 저금통적금"
type: "bank-product"
...
제주은행의 적금 상품 'jbank 저금통적금' 공시 정보입니다.

> Graph-only materialization입니다. 원본 데이터는 JSON export가 authoritative source입니다.

## Metadata
- Materialized ID: `finance.bank.saving.0010020.220002101`
- Type: `bank-product`
- provider: 제주은행
...
- related: `category.finance.source-health`, `finance.provider.9c41509f10eb`, `category.finance.financial-provider-registry`, `category.finance.benchmark-rates`, `finance.benchmark-rate.bok-base-rate`
