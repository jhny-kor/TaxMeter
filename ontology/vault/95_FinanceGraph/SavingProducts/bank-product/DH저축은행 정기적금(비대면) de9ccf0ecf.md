---
materialized_id: "finance.saving.saving.0010404.dh004"
title: "DH저축은행 정기적금(비대면)"
type: "bank-product"
...
DH저축은행의 적금 상품 '정기적금(비대면)' 공시 정보입니다.

> Graph-only materialization입니다. 원본 데이터는 JSON export가 authoritative source입니다.

## Metadata
- Materialized ID: `finance.saving.saving.0010404.dh004`
- Type: `bank-product`
- provider: DH저축은행
