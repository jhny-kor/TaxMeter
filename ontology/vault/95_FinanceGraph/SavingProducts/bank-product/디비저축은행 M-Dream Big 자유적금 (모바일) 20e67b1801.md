---
materialized_id: "finance.bank.saving.0010349.0803"
title: "디비저축은행 M-Dream Big 자유적금 (모바일)"
type: "bank-product"
...
# 디비저축은행 M-Dream Big 자유적금 (모바일)

디비저축은행의 적금 상품 'M-Dream Big 자유적금 (모바일)' 공시 정보입니다.

> Graph-only materialization입니다. 원본 데이터는 JSON export가 authoritative source입니다.

## Metadata
- Materialized ID: `finance.bank.saving.0010349.0803`
- Type: `bank-product`
- provider: 디비저축은행
