---
materialized_id: "finance.bank.saving.0010421.kh3101"
title: "금화저축은행 e-정기적금"
type: "bank-product"
...
금화저축은행의 적금 상품 'e-정기적금' 공시 정보입니다.

> Graph-only materialization입니다. 원본 데이터는 JSON export가 authoritative source입니다.

## Metadata
- Materialized ID: `finance.bank.saving.0010421.kh3101`
- Type: `bank-product`
- provider: 금화저축은행
...
- related: `category.finance.source-health`, `finance.provider.8ed18a6cacff`, `category.finance.financial-provider-registry`, `category.finance.benchmark-rates`, `finance.benchmark-rate.bok-base-rate`
