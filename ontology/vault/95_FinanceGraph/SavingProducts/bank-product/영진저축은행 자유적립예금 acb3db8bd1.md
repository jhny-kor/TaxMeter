---
materialized_id: "finance.bank.saving.0010464.380001"
title: "영진저축은행 자유적립예금"
type: "bank-product"
...
영진저축은행의 적금 상품 '자유적립예금' 공시 정보입니다.

> Graph-only materialization입니다. 원본 데이터는 JSON export가 authoritative source입니다.

## Metadata
- Materialized ID: `finance.bank.saving.0010464.380001`
- Type: `bank-product`
- provider: 영진저축은행
...
- related: `category.finance.source-health`, `finance.provider.cc42a1d54ac3`, `category.finance.financial-provider-registry`, `category.finance.benchmark-rates`, `finance.benchmark-rate.bok-base-rate`
