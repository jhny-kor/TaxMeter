---
materialized_id: "finance.bank.credit-loan.0010019.1"
title: "광주은행 일반신용대출"
type: "bank-product"
...
광주은행의 개인신용대출 상품 '일반신용대출' 공시 정보입니다.

> Graph-only materialization입니다. 원본 데이터는 JSON export가 authoritative source입니다.

## Metadata
- Materialized ID: `finance.bank.credit-loan.0010019.1`
- Type: `bank-product`
- provider: 광주은행
...
- related: `category.finance.source-health`, `finance.provider.acc6bde27a68`, `category.finance.financial-provider-registry`, `category.finance.benchmark-rates`, `finance.benchmark-rate.bok-base-rate`, `finance.benchmark-rate.cofix`
