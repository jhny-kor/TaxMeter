---
materialized_id: "finance.bank.credit-loan.0012627.wr0001f"
title: "㈜케이비국민카드 일반신용대출"
type: "bank-product"
...
㈜케이비국민카드의 개인신용대출 상품 '일반신용대출' 공시 정보입니다.

> Graph-only materialization입니다. 원본 데이터는 JSON export가 authoritative source입니다.

## Metadata
- Materialized ID: `finance.bank.credit-loan.0012627.wr0001f`
- Type: `bank-product`
- provider: ㈜케이비국민카드
