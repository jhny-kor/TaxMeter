---
materialized_id: "finance.bank.deposit.0012711.24541"
title: "엔에이치저축은행 비대면농촌사랑정기예금"
type: "bank-product"
...
# 엔에이치저축은행 비대면농촌사랑정기예금

엔에이치저축은행의 정기예금 상품 '비대면농촌사랑정기예금' 공시 정보입니다.

> Graph-only materialization입니다. 원본 데이터는 JSON export가 authoritative source입니다.

## Metadata
- Materialized ID: `finance.bank.deposit.0012711.24541`
- Type: `bank-product`
- provider: 엔에이치저축은행
