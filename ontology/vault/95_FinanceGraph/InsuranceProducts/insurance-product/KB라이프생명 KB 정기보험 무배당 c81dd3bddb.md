---
materialized_id: "finance.insurance.klia.term-life.kb라이프생명.l611nnb1b1230310"
title: "KB라이프생명 KB 정기보험 무배당"
...
생명보험협회 공시실에 등재된 KB라이프생명의 정기보험 상품 'KB 정기보험 무배당'입니다.

> Graph-only materialization입니다. 원본 데이터는 JSON export가 authoritative source입니다.

## Metadata
- Materialized ID: `finance.insurance.klia.term-life.kb라이프생명.l611nnb1b1230310`
- Type: `insurance-product`
- provider: KB라이프생명
