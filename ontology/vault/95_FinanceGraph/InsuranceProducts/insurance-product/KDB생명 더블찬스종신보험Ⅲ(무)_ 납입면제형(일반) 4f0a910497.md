---
materialized_id: "finance.insurance.klia.whole-life.kdb생명.l330246000102460003nn0000024700020244000102440001000102440001000100020244000100010002000202375"
title: "KDB생명 더블찬스종신보험Ⅲ(무)_ 납입면제형(일반)"
...
# KDB생명 더블찬스종신보험Ⅲ(무)_ 납입면제형(일반)

생명보험협회 공시실에 등재된 KDB생명의 종신보험 상품 '더블찬스종신보험Ⅲ(무)_ 납입면제형(일반)'입니다.

> Graph-only materialization입니다. 원본 데이터는 JSON export가 authoritative source입니다.

## Metadata
- Materialized ID: `finance.insurance.klia.whole-life.kdb생명.l330246000102460003nn0000024700020244000102440001000102440001000100020244000100010002000202375`
- Type: `insurance-product`
- provider: KDB생명
