---
materialized_id: "finance.bank.rent-loan.0010528.760055"
title: "더블저축은행 임차보증금대출"
type: "bank-product"
...
더블저축은행의 전세자금대출 상품 '임차보증금대출' 공시 정보입니다.

> Graph-only materialization입니다. 원본 데이터는 JSON export가 authoritative source입니다.

## Metadata
- Materialized ID: `finance.bank.rent-loan.0010528.760055`
- Type: `bank-product`
- provider: 더블저축은행
...
- related: `category.finance.source-health`, `finance.provider.4ba0cfc1fa76`, `category.finance.financial-provider-registry`, `category.finance.benchmark-rates`, `finance.benchmark-rate.bok-base-rate`, `finance.benchmark-rate.cofix`
