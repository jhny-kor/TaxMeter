---
materialized_id: "finance.bank.rent-loan.0010628.4354"
title: "롯데손해보험주식회사 롯데손해보험\n전세자금대출"
type: "bank-product"
...
롯데손해보험주식회사의 전세자금대출 상품 '롯데손해보험
전세자금대출' 공시 정보입니다.

> Graph-only materialization입니다. 원본 데이터는 JSON export가 authoritative source입니다.

## Metadata
- Materialized ID: `finance.bank.rent-loan.0010628.4354`
- Type: `bank-product`
- provider: 롯데손해보험주식회사
...
- related: `category.finance.source-health`, `finance.provider.f2b1129bb6bd`, `category.finance.financial-provider-registry`, `category.finance.benchmark-rates`, `finance.benchmark-rate.bok-base-rate`, `finance.benchmark-rate.cofix`
