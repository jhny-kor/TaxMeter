---
materialized_id: "finance.bank.rent-loan.0014807.1130"
title: "수협은행 공공주택임차보증금담보대출"
type: "bank-product"
...
수협은행의 전세자금대출 상품 '공공주택임차보증금담보대출' 공시 정보입니다.

> Graph-only materialization입니다. 원본 데이터는 JSON export가 authoritative source입니다.

## Metadata
- Materialized ID: `finance.bank.rent-loan.0014807.1130`
- Type: `bank-product`
- provider: 수협은행
