---
materialized_id: "finance.bank.rent-loan.0010026.212020007"
title: "중소기업은행 IBK전세대출 (HF)"
type: "bank-product"
...
중소기업은행의 전세자금대출 상품 'IBK전세대출 (HF)' 공시 정보입니다.

> Graph-only materialization입니다. 원본 데이터는 JSON export가 authoritative source입니다.

## Metadata
- Materialized ID: `finance.bank.rent-loan.0010026.212020007`
- Type: `bank-product`
- provider: 중소기업은행
