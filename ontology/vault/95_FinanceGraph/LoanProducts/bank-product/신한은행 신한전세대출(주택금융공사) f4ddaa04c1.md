---
materialized_id: "finance.loan.rent-loan.0011625.wr0001a"
title: "신한은행 신한전세대출(주택금융공사)"
type: "bank-product"
...
신한은행의 전세자금대출 상품 '신한전세대출(주택금융공사)' 공시 정보입니다.

> Graph-only materialization입니다. 원본 데이터는 JSON export가 authoritative source입니다.

## Metadata
- Materialized ID: `finance.loan.rent-loan.0011625.wr0001a`
- Type: `bank-product`
- provider: 신한은행
