---
materialized_id: "finance.loan.credit-loan.0012627.wr0002f"
title: "㈜케이비국민카드 장기카드대출"
type: "bank-product"
...
㈜케이비국민카드의 개인신용대출 상품 '장기카드대출' 공시 정보입니다.

> Graph-only materialization입니다. 원본 데이터는 JSON export가 authoritative source입니다.

## Metadata
- Materialized ID: `finance.loan.credit-loan.0012627.wr0002f`
- Type: `bank-product`
- provider: ㈜케이비국민카드
...
- related: `category.finance.source-health`, `finance.provider.3f915f32c33d`, `category.finance.financial-provider-registry`, `category.finance.benchmark-rates`, `finance.benchmark-rate.bok-base-rate`, `finance.benchmark-rate.cofix`
