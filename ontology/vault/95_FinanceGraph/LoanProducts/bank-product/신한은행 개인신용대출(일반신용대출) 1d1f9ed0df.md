---
materialized_id: "finance.loan.credit-loan.0011625.cr0001a"
title: "신한은행 개인신용대출(일반신용대출)"
type: "bank-product"
...
신한은행의 개인신용대출 상품 '개인신용대출(일반신용대출)' 공시 정보입니다.

> Graph-only materialization입니다. 원본 데이터는 JSON export가 authoritative source입니다.

## Metadata
- Materialized ID: `finance.loan.credit-loan.0011625.cr0001a`
- Type: `bank-product`
- provider: 신한은행
