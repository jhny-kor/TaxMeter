---
materialized_id: "finance.bank.rent-loan.0010478.780003"
title: "CK저축은행 일반자금대출(전세자금)"
type: "bank-product"
...
CK저축은행의 전세자금대출 상품 '일반자금대출(전세자금)' 공시 정보입니다.

> Graph-only materialization입니다. 원본 데이터는 JSON export가 authoritative source입니다.

## Metadata
- Materialized ID: `finance.bank.rent-loan.0010478.780003`
- Type: `bank-product`
- provider: CK저축은행
