---
materialized_id: "finance.loan.credit-loan.0010388.d1"
title: "다올저축은행 개인신용대출"
type: "bank-product"
...
다올저축은행의 개인신용대출 상품 '개인신용대출' 공시 정보입니다.

> Graph-only materialization입니다. 원본 데이터는 JSON export가 authoritative source입니다.

## Metadata
- Materialized ID: `finance.loan.credit-loan.0010388.d1`
- Type: `bank-product`
- provider: 다올저축은행
...
- related: `category.finance.source-health`, `finance.provider.b5aafdb7ed02`, `category.finance.financial-provider-registry`, `category.finance.benchmark-rates`, `finance.benchmark-rate.bok-base-rate`, `finance.benchmark-rate.cofix`
