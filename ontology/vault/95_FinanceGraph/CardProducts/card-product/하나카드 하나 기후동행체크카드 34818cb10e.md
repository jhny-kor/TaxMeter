...
비씨카드 체크카드 상품에 공시된 하나카드의 체크카드 상품 '하나 기후동행체크카드'입니다.

> Graph-only materialization입니다. 원본 데이터는 JSON export가 authoritative source입니다.

## Metadata
- Materialized ID: `finance.card.check-card.하나카드.하나-기후동행체크카드-103981`
- Type: `card-product`
- provider: 하나카드
...
- https://www.bccard.com/app/card/CheckCardMain.do?gdsno=103981&mbkNo=025
- https://www.bccard.com/images/individual/card/renew/list/card_103981.png
