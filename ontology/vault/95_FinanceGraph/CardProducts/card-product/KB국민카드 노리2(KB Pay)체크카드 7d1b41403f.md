---
materialized_id: "finance.card.check-card.kb국민카드.노리2-kb-pay-체크카드"
title: "KB국민카드 노리2(KB Pay)체크카드"
type: "card-product"
domain: "card-products"
basis_year: 2026
reviewed_at: "2026-05-05"
source_export: "korea-card-products-ontology-2026.json"
source_urls: ["https://gongsi.crefia.or.kr/portal/carddamoa/carddamoaList", "https://card.kbcard.com/CRD/DVIEW/HCAMCXPRICAC0076?mainCC=a&cooperationcode=07964", "https://gongsi.crefia.or.kr/portal/financialProdInfo/cardProd"]
source_basis_dates: ["2026-05-05 수집", "2026-05-05 확인"]
tags: ["graph-materialized", "card-products", "finance-product", "generated", "check-card"]
---

# KB국민카드 노리2(KB Pay)체크카드

여신금융협회 카드다모아에 공시된 KB국민카드의 체크카드 상품 '노리2(KB Pay)체크카드'입니다.

> Graph-only materialization입니다. 원본 데이터는 JSON export가 authoritative source입니다.

## Metadata
- Materialized ID: `finance.card.check-card.kb국민카드.노리2-kb-pay-체크카드`
- Type: `card-product`
- provider: KB국민카드
