...
# 삼성카드 SK에너지 화물복지 삼성체크카드

삼성카드 체크카드 상품에 공시된 삼성카드의 체크카드 상품 'SK에너지 화물복지 삼성체크카드'입니다.

> Graph-only materialization입니다. 원본 데이터는 JSON export가 authoritative source입니다.

## Metadata
- Materialized ID: `finance.card.check-card.삼성카드.sk에너지-화물복지-삼성체크카드-abp1542`
- Type: `card-product`
- provider: 삼성카드
...
- https://www.samsungcard.com/home/card/cardinfo/PGHPPCCCardCardinfoDetails001?code=ABP1542
- https://static11.samsungcard.com/wcms/home/scard/image/personal/b_ABP1542.png
