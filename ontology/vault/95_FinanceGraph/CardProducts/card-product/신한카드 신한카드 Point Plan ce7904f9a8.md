---
materialized_id: "finance.card.credit-card.신한카드.신한카드-point-plan"
title: "신한카드 신한카드 Point Plan"
type: "card-product"
...
# 신한카드 신한카드 Point Plan

여신금융협회 카드다모아에 공시된 신한카드의 신용카드 상품 '신한카드 Point Plan'입니다.

> Graph-only materialization입니다. 원본 데이터는 JSON export가 authoritative source입니다.

## Metadata
- Materialized ID: `finance.card.credit-card.신한카드.신한카드-point-plan`
- Type: `card-product`
- provider: 신한카드
