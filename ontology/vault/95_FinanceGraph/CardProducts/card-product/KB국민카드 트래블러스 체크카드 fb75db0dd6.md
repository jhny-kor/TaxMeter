---
materialized_id: "finance.card.check-card.kb국민카드.트래블러스-체크카드"
...
source_urls: ["https://gongsi.crefia.or.kr/portal/carddamoa/carddamoaList", "https://card.kbcard.com/CRD/DVIEW/HCAMCXPRICAC0076?mainCC=a&cooperationcode=09562", "https://gongsi.crefia.or.kr/portal/financialProdInfo/cardProd"]
...
여신금융협회 카드다모아에 공시된 KB국민카드의 체크카드 상품 '트래블러스 체크카드'입니다.

> Graph-only materialization입니다. 원본 데이터는 JSON export가 authoritative source입니다.

## Metadata
- Materialized ID: `finance.card.check-card.kb국민카드.트래블러스-체크카드`
- Type: `card-product`
- provider: KB국민카드
