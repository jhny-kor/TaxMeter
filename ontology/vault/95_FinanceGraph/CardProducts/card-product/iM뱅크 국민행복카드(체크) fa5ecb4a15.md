---
materialized_id: "finance.card.check-card.im뱅크.국민행복카드-체크-311786"
title: "iM뱅크 국민행복카드(체크)"
type: "card-product"
...
비씨카드 체크카드 상품에 공시된 iM뱅크의 체크카드 상품 '국민행복카드(체크)'입니다.

> Graph-only materialization입니다. 원본 데이터는 JSON export가 authoritative source입니다.

## Metadata
- Materialized ID: `finance.card.check-card.im뱅크.국민행복카드-체크-311786`
- Type: `card-product`
- provider: iM뱅크
...
- https://www.bccard.com/app/card/CheckCardMain.do?gdsno=311786&mbkNo=031
- https://www.bccard.com/images/individual/card/renew/list/card_311786.png
