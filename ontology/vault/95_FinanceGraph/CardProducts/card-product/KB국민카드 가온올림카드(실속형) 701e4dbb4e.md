---
materialized_id: "finance.card.credit-card.kb국민카드.가온올림카드-실속형-09157"
title: "KB국민카드 가온올림카드(실속형)"
type: "card-product"
...
KB국민카드 카드한눈에보기에 공시된 KB국민카드의 신용카드 상품 '가온올림카드(실속형)'입니다.

> Graph-only materialization입니다. 원본 데이터는 JSON export가 authoritative source입니다.

## Metadata
- Materialized ID: `finance.card.credit-card.kb국민카드.가온올림카드-실속형-09157`
- Type: `card-product`
- provider: KB국민카드
