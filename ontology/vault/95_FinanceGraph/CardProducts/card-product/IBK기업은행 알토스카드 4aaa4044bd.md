---
materialized_id: "finance.card.check-card.ibk기업은행.알토스카드-101642"
title: "IBK기업은행 알토스카드"
type: "card-product"
...
비씨카드 체크카드 상품에 공시된 IBK기업은행의 체크카드 상품 '알토스카드'입니다.

> Graph-only materialization입니다. 원본 데이터는 JSON export가 authoritative source입니다.

## Metadata
- Materialized ID: `finance.card.check-card.ibk기업은행.알토스카드-101642`
- Type: `card-product`
- provider: IBK기업은행
...
- https://www.bccard.com/app/card/CheckCardMain.do?gdsno=101642&mbkNo=003
- https://www.bccard.com/images/individual/card/renew/list/card_101642.png
