...
# 삼성카드 SC제일은행 글로벌 삼성체크카드

삼성카드 체크카드 상품에 공시된 삼성카드의 체크카드 상품 'SC제일은행 글로벌 삼성체크카드'입니다.

> Graph-only materialization입니다. 원본 데이터는 JSON export가 authoritative source입니다.

## Metadata
- Materialized ID: `finance.card.check-card.삼성카드.sc제일은행-글로벌-삼성체크카드-abp1556`
- Type: `card-product`
- provider: 삼성카드
...
- https://www.samsungcard.com/home/card/cardinfo/PGHPPCCCardCardinfoDetails001?code=ABP1556
- https://static11.samsungcard.com/wcms/home/scard/image/personal/b_ABP1556.png
