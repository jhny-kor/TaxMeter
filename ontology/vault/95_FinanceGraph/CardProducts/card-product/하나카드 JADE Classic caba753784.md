---
materialized_id: "finance.card.credit-card.하나카드.jade-classic"
title: "하나카드 JADE Classic"
type: "card-product"
...
여신금융협회 카드다모아에 공시된 하나카드의 신용카드 상품 'JADE Classic'입니다.

> Graph-only materialization입니다. 원본 데이터는 JSON export가 authoritative source입니다.

## Metadata
- Materialized ID: `finance.card.credit-card.하나카드.jade-classic`
- Type: `card-product`
- provider: 하나카드
