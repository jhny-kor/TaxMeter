...
criteria: [{"label": "수도권 밖 이전 감면", "basis": "법인세", "condition": "공장·본사 등 지방 이전 요건 충족", "rate_percent_min": 50, "rate_percent_max": 100, "rate_label": "감면율", "note": "지역과 기간별 차등", "source": "source.nts.corporate-tax.reliefs"}]
law_reference: ""
...
- **수도권 밖 이전 감면**: 기준항목: 법인세; 조건: 공장·본사 등 지방 이전 요건 충족; 최저감면율: 50%; 최고감면율: 100%; 비고: 지역과 기간별 차등; 출처: [[90_Sources/법인세 공제감면|법인세 공제감면]]
