...
criteria: [{"label": "구조조정 과세이연", "basis": "양도차익 등", "condition": "구조조정 및 재무구조개선 요건 충족", "benefit": "손금산입 또는 익금불산입으로 과세이연", "source": "source.nts.corporate-tax.reliefs", "law_reference": "조세특례제한법 제37조부터 제46조까지 중 구조조정·재무구조개선 과세특례 조문", "amount_applicability": "정액 금액 기준 없음"}]
...
- **구조조정 과세이연**: 기준항목: 양도차익 등; 조건: 구조조정 및 재무구조개선 요건 충족; 근거 조항: 조세특례제한법 제37조부터 제46조까지 중 구조조정·재무구조개선 과세특례 조문; 금액 기준 여부: 정액 금액 기준 없음; 혜택: 손금산입 또는 익금불산입으로 과세이연; 출처: [[90_Sources/법인세 공제감면|법인세 공제감면]]
