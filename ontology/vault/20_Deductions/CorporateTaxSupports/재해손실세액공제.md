...
criteria: [{"label": "재해손실세액공제", "basis": "재해상실자산가액 / 상실 전 자산총액", "condition": "사업용 총자산가액의 20% 이상 상실", "rate_percent": 20, "rate_label": "상실비율 문턱", "benefit": "산출세액에 재해상실비율을 곱해 공제", "source": "source.nts.corporate-tax.reliefs", "amount_formula": "재해상실자산가액 / 상실 전 자산총액 × 상실비율 문턱 20%"}]
law_reference: ""
...
- **재해손실세액공제**: 기준항목: 재해상실자산가액 / 상실 전 자산총액; 조건: 사업용 총자산가액의 20% 이상 상실; 상실비율 문턱: 20%; 금액·적용 산식: 재해상실자산가액 / 상실 전 자산총액 × 상실비율 문턱 20%; 혜택: 산출세액에 재해상실비율을 곱해 공제; 출처: [[90_Sources/법인세 공제감면|법인세 공제감면]]
