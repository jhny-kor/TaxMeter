...
criteria: [{"label": "상생결제 지급금액", "basis": "상생결제 지급금액", "condition": "상생결제제도 이용 구매대금 지급", "rate_percent_min": 0.1, "rate_percent_max": 0.3, "rate_label": "세액공제율", "note": "결제기한 구간별 차등", "source": "source.nts.corporate-tax.reliefs"}]
law_reference: ""
...
- **상생결제 지급금액**: 기준항목: 상생결제 지급금액; 조건: 상생결제제도 이용 구매대금 지급; 최저세액공제율: 0.1%; 최고세액공제율: 0.3%; 비고: 결제기한 구간별 차등; 출처: [[90_Sources/법인세 공제감면|법인세 공제감면]]
