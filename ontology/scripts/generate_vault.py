...
NODES = [
    ...
    node("tax.income.capital-gains", "양도소득세", "tax", "부동산, 주식 등 자산 양도차익에 대해 과세되는 소득세입니다.", "10_Taxes/National", parents=["tax.income"], children=["concept.capital-gains.calculation-flow", "concept.capital-gains.stock-basic-deduction", "filing.capital-gains-return"], related=["tax.securities-transaction"], sources=["source.national-tax-framework-act.2026.article2", "source.nts.capital-gains.overview", "source.nts.capital-gains.deadline"], terms=["term.tax-base", "term.capital-gain", "term.deadline"], deadlines=["deadline.capital-gains.preliminary", "deadline.capital-gains.final"], basis_year=2026),
    node("tax.inheritance", "상속세", "tax", "사망으로 이전되는 재산에 과세되는 세금입니다.", "10_Taxes/National", parents=["tax.inheritance-and-gift"], children=["filing.inheritance-tax-return"], sources=["source.national-tax-framework-act.2026.article2", "source.nts.inheritance.overview"], terms=["term.tax-base", "term.heir"], deadlines=["deadline.inheritance.resident", "deadline.inheritance.nonresident"], basis_year=2026),
    node("tax.gift", "증여세", "tax", "무상 이전되는 재산에 과세되는 세금입니다.", "10_Taxes/National", parents=["tax.inheritance-and-gift"], children=["filing.gift-tax-return"], sources=["source.national-tax-framework-act.2026.article2", "source.nts.gift.deadline"], terms=["term.tax-base", "term.donee"], deadlines=["deadline.gift.general"], basis_year=2026),
    ...
    local_tax("local.property", "재산세", "토지, 건축물, 주택 등 재산 보유에 대해 과세되는 지방 보통세입니다.", "category.local-ordinary-taxes", related=["tax.comprehensive-real-estate"], terms=["term.local-tax", "term.publicly-notified-price"]),
...
NODES.extend([
    ...
    node("filing.business-income-withholding", "사업소득 원천징수", "filing", "프리랜서 등 원천징수 대상 사업소득을 지급할 때 지급금액의 일정 비율을 원천징수하고 정해진 기한에 신고·납부하는 흐름입니다.", "60_Business", parents=["category.business-tax-compliance", "filing.withholding-tax"], related=["tax.income.comprehensive"], terms=["term.withholding", "term.withholding-obligor", "term.deadline-special-rule"], deadlines=["deadline.withholding.monthly", "deadline.withholding.semiannual"], sources=["source.nts.business-income.withholding", "source.nts.withholding.overview"], tags=["business-compliance"]),
    ...
    node("concept.simple-vat-taxpayer", "간이과세자 기준", "concept", "부가가치세에서 1년 매출액 10,400만원 미만 개인사업자에게 적용되는 납세 유형 기준입니다. 사업자등록 단계에서 간이과세 배제 업종과 일반과세자 전환 가능성을 함께 확인합니다.", "40_Terms/Concepts", parents=["tax.value-added"], related=["concept.general-vat-taxpayer", "concept.vat-payment-exemption", "filing.business-registration", "filing.vat-return"], terms=["term.simple-vat-taxpayer"], deadlines=["deadline.vat.simplified.annual", "deadline.vat.simplified.preliminary"], sources=["source.nts.vat.overview", "source.nts.vat.filing-duty", "source.nts.business-registration.application"]),
    node("concept.vat-payment-exemption", "간이과세자 납부의무 면제", "concept", "직전연도 공급대가가 일정 금액 미만인 간이과세자는 부가가치세 납부세액의 납부의무가 면제될 수 있어 신고와 납부 판단을 분리해 확인해야 합니다.", "40_Terms/Concepts", parents=["tax.value-added"], related=["concept.simple-vat-taxpayer", "filing.vat-return"], terms=["term.simple-vat-taxpayer"], sources=["source.nts.vat.filing-duty"]),
