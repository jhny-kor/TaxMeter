...
EXPORT_CONFIGS = (
    ...
    },
    {
        ...
        "path": EXPORTS / "korea-deposit-products-ontology-2026.json",
        "folder": "DepositProducts",
        "include_reference_items": True,
        "bridge": "00_Index/은행 상품 온톨로지",
    },
    {
        "domain": "saving-products",
        "path": EXPORTS / "korea-saving-products-ontology-2026.json",
        "folder": "SavingProducts",
        "include_reference_items": True,
        "bridge": "00_Index/은행 상품 온톨로지",
    },
    {
        "domain": "loan-products",
        "path": EXPORTS / "korea-loan-products-ontology-2026.json",
        "folder": "LoanProducts",
        "include_reference_items": True,
        "bridge": "00_Index/은행 상품 온톨로지",
    },
