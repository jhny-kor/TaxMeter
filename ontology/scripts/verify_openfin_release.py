...
SCRIPTS = (
    ...
    "validate_exact_product_resolution.py",
    "validate_personal_finance.py",
    "validate_openfin_120.py",
    ...
    "validate_compare_engine.py",
    "validate_verification_evidence.py",
    "validate_verification_expiration.py",
    "validate_semantic_duplicates.py",
    "validate_support_relevance.py",
    "validate_grade_policy.py",
    "validate_sales_status_contract.py",
    "validate_local_cloudflare_parity.py",
